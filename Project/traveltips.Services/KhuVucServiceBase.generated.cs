...
{		
	...
	/// All custom implementations should be done in the <see cref="KhuVuc"/> class.
	/// </remarks>
	[DataObject]
	[CLSCompliant(true)]
	public partial class KhuVucServiceBase : ServiceBase<KhuVuc, KhuVucKey>
	{

		#region Constructors
		///<summary>
		/// Creates a new <see cref="KhuVuc"/> instance .
		///</summary>
		public KhuVucServiceBase() : base()
		{
		}
		...
		public static KhuVuc CreateKhuVuc(System.String tenKv, System.Byte[] maKv, System.String moTa, System.Byte? flag)
		{
			...
			newEntityKhuVuc.Flag  = flag;
			return newEntityKhuVuc;
		}
		#endregion Constructors


		#region Fields
		private static SecurityContext<KhuVuc> securityContext = new SecurityContext<KhuVuc>();
		...
		///</summary>
		public static SecurityContext<KhuVuc> SecurityContext
		{
			get
			{
		...
		public override KhuVuc Get(KhuVucKey key)
		{
			return GetByIdKhuVuc(key.IdKhuVuc);
		}

		/// <summary>
		///  method that Gets rows in a <see cref="TList{KhuVuc}" /> from the datasource based on the primary key PK_tbl_KhuVuc index.
		/// </summary>
		/// <param name="idKhuVuc"></param>
		/// <returns>Returns an instance of the <see cref="KhuVuc"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual KhuVuc GetByIdKhuVuc(System.Int64 idKhuVuc)
		{
			int totalCount = -1;
			return GetByIdKhuVuc(idKhuVuc, 0, defaultMaxRecords, out totalCount);
		}
		...
		/// <returns>Returns an instance of the <see cref="KhuVuc"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual KhuVuc GetByIdKhuVuc(System.Int64 idKhuVuc, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetByIdKhuVuc");
			totalCount = -1;
            ...
            {	
				...
				//Access Repository
				entity = dataProvider.KhuVucProvider.GetByIdKhuVuc(transactionManager, idKhuVuc, start, pageLength, out totalCount)   as KhuVuc;
		...
		#region GetAll
		/// <summary>
		/// Get a complete collection of <see cref="KhuVuc" /> entities.
		/// </summary>
		/// <returns></returns>
		public override TList<KhuVuc> GetAll() 
		{
			int totalCount = -1;
		...
		/// <summary>
		/// Get a set portion of a complete list of <see cref="KhuVuc" /> entities
		/// </summary>
		/// <param name="start">Row number at which to start reading.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="totalCount">out parameter, number of total rows in given query.</param>
		/// <returns>a <see cref="TList{KhuVuc}"/> </returns>
		public virtual TList<KhuVuc> GetAll(int start, int pageLength, out int totalCount) 
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetAll");
			
			// get this data
			TList<KhuVuc> list = null;
			totalCount = -1;
			TransactionManager transactionManager = null; 
            ...
            {	
				...
				//Access repository
				list = dataProvider.KhuVucProvider.GetAll(transactionManager, start, pageLength, out totalCount);	
			}
            catch (Exception exc)
            {
				//if open, rollback, it's possible this is part of a  larger commit
		...
		#region GetPaged
		/// <summary>
		/// Gets a page of <see cref="TList{KhuVuc}" /> rows from the DataSource.
		/// </summary>
		/// <param name="totalCount">Out Parameter, Number of rows in the DataSource.</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>KhuVuc</c> objects.</returns>
		public virtual TList<KhuVuc> GetPaged(out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>KhuVuc</c> objects.</returns>
		public virtual TList<KhuVuc> GetPaged(int start, int pageLength, out int totalCount)
		{
			return GetPaged(null, null, start, pageLength, out totalCount);
		}

		/// <summary>
		/// Gets a page of entity rows with a <see cref="TList{KhuVuc}" /> from the DataSource with a where clause and order by clause.
		/// </summary>
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>KhuVuc</c> objects.</returns>
		public override TList<KhuVuc> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.KhuVucProvider.GetPaged(transactionManager, whereClause, orderBy, start, pageLength, out totalCount);
		...
		public virtual TList<KhuVuc> Find(string whereClause)
		{
			int totalCount = -1;
		...
		public override TList<KhuVuc> Find(string whereClause, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.KhuVucProvider.Find(transactionManager, whereClause, start, pageLength, out totalCount);
		...
		/// <returns>Returns a typed collection of <c>KhuVuc</c> objects.</returns>
		public virtual TList<KhuVuc> Find(IFilterParameterCollection parameters)
		{
		...
		/// <param name="orderBy">Specifies the sort criteria for the rows in the DataSource (Name ASC; BirthDay DESC, Name ASC);</param>
		/// <returns>Returns a typed collection of <c>KhuVuc</c> objects.</returns>
		public virtual TList<KhuVuc> Find(IFilterParameterCollection parameters, string orderBy)
		{
			int count = 0;
		...
		/// <returns>Returns a typed collection of <c>KhuVuc</c> objects.</returns>
		public virtual TList<KhuVuc> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				//Access repository
				list = dataProvider.KhuVucProvider.Find(transactionManager, parameters, orderBy, start, pageLength, out count);
			}
            catch (Exception exc)
            {
				//if open, rollback, it's possible this is part of a larger commit
		...
		public override bool Insert(KhuVuc entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.KhuVucProvider.Insert(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Inserts rows in <see cref="TList{KhuVuc}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>KhuVuc</c> objects in a <see cref="TList{KhuVuc}" /> object to Insert.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Insert)]
		public virtual TList<KhuVuc> Insert(TList<KhuVuc> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Insert");
			...
			{
				throw new Entities.EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<KhuVuc>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Insert
				dataProvider.KhuVucProvider.Insert(transactionManager, entityCollection); 
		...
		public override bool Update(KhuVuc entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.KhuVucProvider.Update(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Updates rows in <see cref="TList{KhuVuc}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>KhuVuc</c> objects in a <see cref="TList{KhuVuc}" /> object to Update.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<KhuVuc> Update(TList<KhuVuc> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Update");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<KhuVuc>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Update
				dataProvider.KhuVucProvider.Update(transactionManager, entityCollection); 
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override KhuVuc Save(KhuVuc entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				dataProvider.KhuVucProvider.Save(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Saves rows in <see cref="TList{KhuVuc}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>KhuVuc</c> objects in a <see cref="TList{KhuVuc}" /> object to Save.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<KhuVuc> Save(TList<KhuVuc> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Save");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<KhuVuc>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Save
				dataProvider.KhuVucProvider.Save(transactionManager, entityCollection); 
		...
		public override bool Delete(KhuVuc entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.KhuVucProvider.Delete(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Deletes rows in <see cref="TList{KhuVuc}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>KhuVuc</c> objects in a <see cref="TList{KhuVuc}" /> object to Delete.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual TList<KhuVuc> Delete(TList<KhuVuc> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<KhuVuc>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Delete
				dataProvider.KhuVucProvider.Delete(transactionManager, entityCollection); 
		...
		public bool Delete(KhuVucKey key)
		{
			return Delete(key.IdKhuVuc );
		}
		...
		/// <returns>Returns true if operation suceeded.</returns>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual bool Delete(System.Int64 idKhuVuc)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			try
            {
				...
				//Delete
				result = dataProvider.KhuVucProvider.Delete(transactionManager, idKhuVuc);
		...
		/// <summary>
		/// public virtualDeep Loads the requested <see cref="KhuVuc"/> by the entity keys.  The criteria of the child 
		...
		/// <returns>Returns an instance of the <see cref="KhuVuc"/> class and DeepLoaded.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual KhuVuc DeepLoadByIdKhuVuc(System.Int64 idKhuVuc, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadByIdKhuVuc");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			KhuVuc entity = GetByIdKhuVuc(idKhuVuc);
		...
		/// <remarks>
		/// <seealso cref="DeepLoad(KhuVuc)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(KhuVuc entity)
		{
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(KhuVuc entity, bool deep)
		{
		...
		/// </remarks>
		/// <param name="entity">The <see cref="KhuVuc"/> object to load.</param>
		...
		/// <param name="childTypes">KhuVuc Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(KhuVuc entity, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			...
			try
            {
				...
				dataProvider.KhuVucProvider.DeepLoad(transactionManager, entity, deep, deepLoadType, childTypes);
		...
		/// <summary>
		/// Deep Loads the <see cref="TList{KhuVuc}" /> object with all of the child 
		/// property collections only 1 Level Deep.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(KhuVuc)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		/// <param name="entityCollection">the <see cref="TList{KhuVuc}" /> Object to deep loads.</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<KhuVuc> entityCollection)
		{
			DeepLoad(entityCollection, false, DeepLoadType.ExcludeChildren, Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Loads the <see cref="TList{KhuVuc}" /> object.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(KhuVuc)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<KhuVuc> entityCollection, bool deep)
		{
			DeepLoad(entityCollection, deep, DeepLoadType.ExcludeChildren, Type.EmptyTypes);
		}	

		/// <summary>
		/// Deep Loads the entire <see cref="TList{KhuVuc}" /> object with criteria based of the child 
		/// property collections only N Levels Deep based on the DeepLoadType.
		/// </summary>
		/// <remarks>
		/// Use this method with caution as it is possible to DeepLoad with Recursion and traverse an entire collection's object graph.
		/// </remarks>
		/// <param name="entityCollection">The <see cref="TList{KhuVuc}" /> instance to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		...
		///	</param>
		/// <param name="childTypes"><see cref="KhuVuc"/> Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public override void DeepLoad(TList<KhuVuc> entityCollection, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{	
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoad");
			TransactionManager transactionManager = null; 
			...
			try
            {
				...
				//Call Deep Load from the Repository
				dataProvider.KhuVucProvider.DeepLoad(transactionManager, entityCollection, deep, deepLoadType, childTypes);
		...
		/// <summary>
		/// public virtualDeep Saves the <see cref="KhuVuc"/> object with all of the child
		/// property collections N Levels Deep.
		/// </summary>
		/// <param name="entity">KhuVuc Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(KhuVuc entity)
		{
		...
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(KhuVuc entity, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Save
				result = dataProvider.KhuVucProvider.DeepSave(transactionManager, entity, deepSaveType, childTypes);
		...
		/// <summary>
		/// Deep Save the entire <see cref="TList{KhuVuc}" /> object with all of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection">TList{KhuVuc} Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual bool DeepSave(TList<KhuVuc> entityCollection)
		{
			return DeepSave(entityCollection, DeepSaveType.ExcludeChildren, Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Save the entire object graph of the <see cref="TList{KhuVuc}" /> object with criteria based of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection"><see cref="TList{KhuVuc}" /> Object</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">KhuVuc Property Collection Type Array To Include or Exclude from Save</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(TList<KhuVuc> entityCollection, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{				
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepSave");
			...
			try
            {
				...
				transactionManager = ConnectionScope.ValidateOrCreateTransaction();
				NetTiersProvider dataProvider = ConnectionScope.Current.DataProvider;
				result = dataProvider.KhuVucProvider.DeepSave(transactionManager, entityCollection,  deepSaveType, childTypes);
