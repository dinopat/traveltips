...
{		
	...
	/// All custom implementations should be done in the <see cref="ThuocTinhSanPham"/> class.
	/// </remarks>
	[DataObject]
	[CLSCompliant(true)]
	public partial class ThuocTinhSanPhamServiceBase : ServiceBase<ThuocTinhSanPham, ThuocTinhSanPhamKey>
	{

		#region Constructors
		///<summary>
		/// Creates a new <see cref="ThuocTinhSanPham"/> instance .
		///</summary>
		public ThuocTinhSanPhamServiceBase() : base()
		{
		}
		...
		public static ThuocTinhSanPham CreateThuocTinhSanPham(System.Int64 idTtsp, System.Int64? idSanPham, System.Int64? idThuocTinh, System.String value1, System.String value2, System.Byte? flag)
		{
			...
			newEntityThuocTinhSanPham.Value2  = value2;
			newEntityThuocTinhSanPham.Flag  = flag;
			return newEntityThuocTinhSanPham;
		}
		#endregion Constructors


		#region Fields
		private static SecurityContext<ThuocTinhSanPham> securityContext = new SecurityContext<ThuocTinhSanPham>();
		...
		///</summary>
		public static SecurityContext<ThuocTinhSanPham> SecurityContext
		{
			get
			{
		...
		/// <returns>Returns a generic collection of ThuocTinhSanPham objects.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual TList<ThuocTinhSanPham> GetByIdSanPham(System.Int64? idSanPham)
		{
			int totalCount = -1;
			return GetByIdSanPham(idSanPham, 0, defaultMaxRecords, out totalCount);
		}
		...
		/// <returns>Returns a collection <see cref="TList{ThuocTinhSanPham}" /> of <c>ThuocTinhSanPham</c> objects.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual TList<ThuocTinhSanPham> GetByIdSanPham(System.Int64? idSanPham, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetByIdSanPham");
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public override ThuocTinhSanPham Get(ThuocTinhSanPhamKey key)
		{
			return GetByIdTtsp(key.IdTtsp);
		}

		/// <summary>
		///  method that Gets rows in a <see cref="TList{ThuocTinhSanPham}" /> from the datasource based on the primary key PK_tbl_ThuocTinhSanPham index.
		/// </summary>
		/// <param name="idTtsp"></param>
		/// <returns>Returns an instance of the <see cref="ThuocTinhSanPham"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual ThuocTinhSanPham GetByIdTtsp(System.Int64 idTtsp)
		{
			int totalCount = -1;
			return GetByIdTtsp(idTtsp, 0, defaultMaxRecords, out totalCount);
		}
		...
		/// <returns>Returns an instance of the <see cref="ThuocTinhSanPham"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual ThuocTinhSanPham GetByIdTtsp(System.Int64 idTtsp, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetByIdTtsp");
			totalCount = -1;
            ...
            {	
				...
				//Access Repository
				entity = dataProvider.ThuocTinhSanPhamProvider.GetByIdTtsp(transactionManager, idTtsp, start, pageLength, out totalCount)   as ThuocTinhSanPham;
		...
		#region GetAll
		/// <summary>
		/// Get a complete collection of <see cref="ThuocTinhSanPham" /> entities.
		/// </summary>
		/// <returns></returns>
		public override TList<ThuocTinhSanPham> GetAll() 
		{
			int totalCount = -1;
		...
		/// <summary>
		/// Get a set portion of a complete list of <see cref="ThuocTinhSanPham" /> entities
		/// </summary>
		/// <param name="start">Row number at which to start reading.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="totalCount">out parameter, number of total rows in given query.</param>
		/// <returns>a <see cref="TList{ThuocTinhSanPham}"/> </returns>
		public virtual TList<ThuocTinhSanPham> GetAll(int start, int pageLength, out int totalCount) 
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.ThuocTinhSanPhamProvider.GetAll(transactionManager, start, pageLength, out totalCount);	
			}
            catch (Exception exc)
            {
				//if open, rollback, it's possible this is part of a  larger commit
		...
		#region GetPaged
		/// <summary>
		/// Gets a page of <see cref="TList{ThuocTinhSanPham}" /> rows from the DataSource.
		/// </summary>
		/// <param name="totalCount">Out Parameter, Number of rows in the DataSource.</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>ThuocTinhSanPham</c> objects.</returns>
		public virtual TList<ThuocTinhSanPham> GetPaged(out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>ThuocTinhSanPham</c> objects.</returns>
		public virtual TList<ThuocTinhSanPham> GetPaged(int start, int pageLength, out int totalCount)
		{
			return GetPaged(null, null, start, pageLength, out totalCount);
		}

		/// <summary>
		/// Gets a page of entity rows with a <see cref="TList{ThuocTinhSanPham}" /> from the DataSource with a where clause and order by clause.
		/// </summary>
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>ThuocTinhSanPham</c> objects.</returns>
		public override TList<ThuocTinhSanPham> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.ThuocTinhSanPhamProvider.GetPaged(transactionManager, whereClause, orderBy, start, pageLength, out totalCount);
		...
		public virtual TList<ThuocTinhSanPham> Find(string whereClause)
		{
			int totalCount = -1;
		...
		public override TList<ThuocTinhSanPham> Find(string whereClause, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.ThuocTinhSanPhamProvider.Find(transactionManager, whereClause, start, pageLength, out totalCount);
		...
		/// <returns>Returns a typed collection of <c>ThuocTinhSanPham</c> objects.</returns>
		public virtual TList<ThuocTinhSanPham> Find(IFilterParameterCollection parameters)
		{
		...
		/// <param name="orderBy">Specifies the sort criteria for the rows in the DataSource (Name ASC; BirthDay DESC, Name ASC);</param>
		/// <returns>Returns a typed collection of <c>ThuocTinhSanPham</c> objects.</returns>
		public virtual TList<ThuocTinhSanPham> Find(IFilterParameterCollection parameters, string orderBy)
		{
			int count = 0;
		...
		/// <returns>Returns a typed collection of <c>ThuocTinhSanPham</c> objects.</returns>
		public virtual TList<ThuocTinhSanPham> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				//Access repository
				list = dataProvider.ThuocTinhSanPhamProvider.Find(transactionManager, parameters, orderBy, start, pageLength, out count);
			}
            catch (Exception exc)
            {
				//if open, rollback, it's possible this is part of a larger commit
		...
		public override bool Insert(ThuocTinhSanPham entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.ThuocTinhSanPhamProvider.Insert(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Inserts rows in <see cref="TList{ThuocTinhSanPham}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>ThuocTinhSanPham</c> objects in a <see cref="TList{ThuocTinhSanPham}" /> object to Insert.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Insert)]
		public virtual TList<ThuocTinhSanPham> Insert(TList<ThuocTinhSanPham> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Insert");
			...
			{
				throw new Entities.EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<ThuocTinhSanPham>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Insert
				dataProvider.ThuocTinhSanPhamProvider.Insert(transactionManager, entityCollection); 
		...
		public override bool Update(ThuocTinhSanPham entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.ThuocTinhSanPhamProvider.Update(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Updates rows in <see cref="TList{ThuocTinhSanPham}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>ThuocTinhSanPham</c> objects in a <see cref="TList{ThuocTinhSanPham}" /> object to Update.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<ThuocTinhSanPham> Update(TList<ThuocTinhSanPham> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Update");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<ThuocTinhSanPham>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Update
				dataProvider.ThuocTinhSanPhamProvider.Update(transactionManager, entityCollection); 
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override ThuocTinhSanPham Save(ThuocTinhSanPham entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				dataProvider.ThuocTinhSanPhamProvider.Save(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Saves rows in <see cref="TList{ThuocTinhSanPham}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>ThuocTinhSanPham</c> objects in a <see cref="TList{ThuocTinhSanPham}" /> object to Save.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<ThuocTinhSanPham> Save(TList<ThuocTinhSanPham> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Save");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<ThuocTinhSanPham>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Save
				dataProvider.ThuocTinhSanPhamProvider.Save(transactionManager, entityCollection); 
		...
		public override bool Delete(ThuocTinhSanPham entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.ThuocTinhSanPhamProvider.Delete(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Deletes rows in <see cref="TList{ThuocTinhSanPham}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>ThuocTinhSanPham</c> objects in a <see cref="TList{ThuocTinhSanPham}" /> object to Delete.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual TList<ThuocTinhSanPham> Delete(TList<ThuocTinhSanPham> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<ThuocTinhSanPham>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Delete
				dataProvider.ThuocTinhSanPhamProvider.Delete(transactionManager, entityCollection); 
		...
		public bool Delete(ThuocTinhSanPhamKey key)
		{
			return Delete(key.IdTtsp );
		}
		...
		/// <returns>Returns true if operation suceeded.</returns>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual bool Delete(System.Int64 idTtsp)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			try
            {
				...
				//Delete
				result = dataProvider.ThuocTinhSanPhamProvider.Delete(transactionManager, idTtsp);
		...
		/// <summary>
		/// public virtualDeep Loads the requested <see cref="ThuocTinhSanPham"/> by the entity keys.  The criteria of the child 
		...
		/// <returns>Returns an instance of the <see cref="ThuocTinhSanPham"/> class and DeepLoaded.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual ThuocTinhSanPham DeepLoadByIdTtsp(System.Int64 idTtsp, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadByIdTtsp");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			ThuocTinhSanPham entity = GetByIdTtsp(idTtsp);
		...
		/// <remarks>
		/// <seealso cref="DeepLoad(ThuocTinhSanPham)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(ThuocTinhSanPham entity)
		{
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(ThuocTinhSanPham entity, bool deep)
		{
		...
		/// </remarks>
		/// <param name="entity">The <see cref="ThuocTinhSanPham"/> object to load.</param>
		...
		/// <param name="childTypes">ThuocTinhSanPham Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(ThuocTinhSanPham entity, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			...
			try
            {
				...
				dataProvider.ThuocTinhSanPhamProvider.DeepLoad(transactionManager, entity, deep, deepLoadType, childTypes);
		...
		/// <summary>
		/// Deep Loads the <see cref="TList{ThuocTinhSanPham}" /> object with all of the child 
		/// property collections only 1 Level Deep.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(ThuocTinhSanPham)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		/// <param name="entityCollection">the <see cref="TList{ThuocTinhSanPham}" /> Object to deep loads.</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<ThuocTinhSanPham> entityCollection)
		{
			DeepLoad(entityCollection, false, DeepLoadType.ExcludeChildren, Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Loads the <see cref="TList{ThuocTinhSanPham}" /> object.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(ThuocTinhSanPham)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<ThuocTinhSanPham> entityCollection, bool deep)
		{
			DeepLoad(entityCollection, deep, DeepLoadType.ExcludeChildren, Type.EmptyTypes);
		}	

		/// <summary>
		/// Deep Loads the entire <see cref="TList{ThuocTinhSanPham}" /> object with criteria based of the child 
		/// property collections only N Levels Deep based on the DeepLoadType.
		/// </summary>
		/// <remarks>
		/// Use this method with caution as it is possible to DeepLoad with Recursion and traverse an entire collection's object graph.
		/// </remarks>
		/// <param name="entityCollection">The <see cref="TList{ThuocTinhSanPham}" /> instance to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		...
		///	</param>
		/// <param name="childTypes"><see cref="ThuocTinhSanPham"/> Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public override void DeepLoad(TList<ThuocTinhSanPham> entityCollection, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{	
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoad");
			TransactionManager transactionManager = null; 
			...
			try
            {
				...
				//Call Deep Load from the Repository
				dataProvider.ThuocTinhSanPhamProvider.DeepLoad(transactionManager, entityCollection, deep, deepLoadType, childTypes);
		...
		/// <summary>
		/// public virtualDeep Saves the <see cref="ThuocTinhSanPham"/> object with all of the child
		/// property collections N Levels Deep.
		/// </summary>
		/// <param name="entity">ThuocTinhSanPham Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(ThuocTinhSanPham entity)
		{
		...
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(ThuocTinhSanPham entity, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Save
				result = dataProvider.ThuocTinhSanPhamProvider.DeepSave(transactionManager, entity, deepSaveType, childTypes);
		...
		/// <summary>
		/// Deep Save the entire <see cref="TList{ThuocTinhSanPham}" /> object with all of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection">TList{ThuocTinhSanPham} Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual bool DeepSave(TList<ThuocTinhSanPham> entityCollection)
		{
			return DeepSave(entityCollection, DeepSaveType.ExcludeChildren, Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Save the entire object graph of the <see cref="TList{ThuocTinhSanPham}" /> object with criteria based of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection"><see cref="TList{ThuocTinhSanPham}" /> Object</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">ThuocTinhSanPham Property Collection Type Array To Include or Exclude from Save</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(TList<ThuocTinhSanPham> entityCollection, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{				
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepSave");
			...
			try
            {
				...
				transactionManager = ConnectionScope.ValidateOrCreateTransaction();
				NetTiersProvider dataProvider = ConnectionScope.Current.DataProvider;
				result = dataProvider.ThuocTinhSanPhamProvider.DeepSave(transactionManager, entityCollection,  deepSaveType, childTypes);
