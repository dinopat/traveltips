...
{		
	...
	/// All custom implementations should be done in the <see cref="LabelNn"/> class.
	/// </remarks>
	[DataObject]
	[CLSCompliant(true)]
	public partial class LabelNnServiceBase : ServiceBase<LabelNn, LabelNnKey>
	{

		#region Constructors
		///<summary>
		/// Creates a new <see cref="LabelNn"/> instance .
		///</summary>
		public LabelNnServiceBase() : base()
		{
		}
		...
		public static LabelNn CreateLabelNn(System.Int64 idLabel, System.String maLabel, System.String tenLabel, System.String moTa, System.Byte? flag)
		{
			...
			newEntityLabelNn.Flag  = flag;
			return newEntityLabelNn;
		}
		#endregion Constructors


		#region Fields
		private static SecurityContext<LabelNn> securityContext = new SecurityContext<LabelNn>();
		...
		///</summary>
		public static SecurityContext<LabelNn> SecurityContext
		{
			get
			{
		...
		public override LabelNn Get(LabelNnKey key)
		{
			return GetByIdLabel(key.IdLabel);
		}

		/// <summary>
		///  method that Gets rows in a <see cref="TList{LabelNn}" /> from the datasource based on the primary key PK_tbl_Label index.
		/// </summary>
		/// <param name="idLabel"></param>
		/// <returns>Returns an instance of the <see cref="LabelNn"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual LabelNn GetByIdLabel(System.Int64 idLabel)
		{
			int totalCount = -1;
		...
		/// <returns>Returns an instance of the <see cref="LabelNn"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual LabelNn GetByIdLabel(System.Int64 idLabel, int start, int pageLength, out int totalCount)
		{
            ...
            {	
				...
				//Access Repository
				entity = dataProvider.LabelNnProvider.GetByIdLabel(transactionManager, idLabel, start, pageLength, out totalCount)   as LabelNn;
		...
		#region GetAll
		/// <summary>
		/// Get a complete collection of <see cref="LabelNn" /> entities.
		/// </summary>
		/// <returns></returns>
		public override TList<LabelNn> GetAll() 
		{
			int totalCount = -1;
		...
		/// <summary>
		/// Get a set portion of a complete list of <see cref="LabelNn" /> entities
		/// </summary>
		/// <param name="start">Row number at which to start reading.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="totalCount">out parameter, number of total rows in given query.</param>
		/// <returns>a <see cref="TList{LabelNn}"/> </returns>
		public virtual TList<LabelNn> GetAll(int start, int pageLength, out int totalCount) 
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetAll");
			
			// get this data
			TList<LabelNn> list = null;
			totalCount = -1;
			TransactionManager transactionManager = null; 
            ...
            {	
				...
				//Access repository
				list = dataProvider.LabelNnProvider.GetAll(transactionManager, start, pageLength, out totalCount);	
			}
            catch (Exception exc)
            {
				//if open, rollback, it's possible this is part of a  larger commit
		...
		#region GetPaged
		/// <summary>
		/// Gets a page of <see cref="TList{LabelNn}" /> rows from the DataSource.
		/// </summary>
		/// <param name="totalCount">Out Parameter, Number of rows in the DataSource.</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>LabelNn</c> objects.</returns>
		public virtual TList<LabelNn> GetPaged(out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>LabelNn</c> objects.</returns>
		public virtual TList<LabelNn> GetPaged(int start, int pageLength, out int totalCount)
		{
			return GetPaged(null, null, start, pageLength, out totalCount);
		}

		/// <summary>
		/// Gets a page of entity rows with a <see cref="TList{LabelNn}" /> from the DataSource with a where clause and order by clause.
		/// </summary>
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>LabelNn</c> objects.</returns>
		public override TList<LabelNn> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.LabelNnProvider.GetPaged(transactionManager, whereClause, orderBy, start, pageLength, out totalCount);
		...
		public virtual TList<LabelNn> Find(string whereClause)
		{
			int totalCount = -1;
		...
		public override TList<LabelNn> Find(string whereClause, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.LabelNnProvider.Find(transactionManager, whereClause, start, pageLength, out totalCount);
		...
		/// <returns>Returns a typed collection of <c>LabelNn</c> objects.</returns>
		public virtual TList<LabelNn> Find(IFilterParameterCollection parameters)
		{
		...
		/// <param name="orderBy">Specifies the sort criteria for the rows in the DataSource (Name ASC; BirthDay DESC, Name ASC);</param>
		/// <returns>Returns a typed collection of <c>LabelNn</c> objects.</returns>
		public virtual TList<LabelNn> Find(IFilterParameterCollection parameters, string orderBy)
		{
			int count = 0;
		...
		/// <returns>Returns a typed collection of <c>LabelNn</c> objects.</returns>
		public virtual TList<LabelNn> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				//Access repository
				list = dataProvider.LabelNnProvider.Find(transactionManager, parameters, orderBy, start, pageLength, out count);
			}
            catch (Exception exc)
            {
				//if open, rollback, it's possible this is part of a larger commit
		...
		public override bool Insert(LabelNn entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.LabelNnProvider.Insert(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Inserts rows in <see cref="TList{LabelNn}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>LabelNn</c> objects in a <see cref="TList{LabelNn}" /> object to Insert.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Insert)]
		public virtual TList<LabelNn> Insert(TList<LabelNn> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Insert");
			...
			{
				throw new Entities.EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<LabelNn>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Insert
				dataProvider.LabelNnProvider.Insert(transactionManager, entityCollection); 
		...
		public override bool Update(LabelNn entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.LabelNnProvider.Update(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Updates rows in <see cref="TList{LabelNn}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>LabelNn</c> objects in a <see cref="TList{LabelNn}" /> object to Update.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<LabelNn> Update(TList<LabelNn> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Update");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<LabelNn>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Update
				dataProvider.LabelNnProvider.Update(transactionManager, entityCollection); 
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override LabelNn Save(LabelNn entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				dataProvider.LabelNnProvider.Save(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Saves rows in <see cref="TList{LabelNn}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>LabelNn</c> objects in a <see cref="TList{LabelNn}" /> object to Save.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<LabelNn> Save(TList<LabelNn> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Save");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<LabelNn>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Save
				dataProvider.LabelNnProvider.Save(transactionManager, entityCollection); 
		...
		public override bool Delete(LabelNn entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.LabelNnProvider.Delete(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Deletes rows in <see cref="TList{LabelNn}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>LabelNn</c> objects in a <see cref="TList{LabelNn}" /> object to Delete.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual TList<LabelNn> Delete(TList<LabelNn> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<LabelNn>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Delete
				dataProvider.LabelNnProvider.Delete(transactionManager, entityCollection); 
		...
		public bool Delete(LabelNnKey key)
		{
			return Delete(key.IdLabel );
		}
		...
		/// <returns>Returns true if operation suceeded.</returns>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual bool Delete(System.Int64 idLabel)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			try
            {
				...
				//Delete
				result = dataProvider.LabelNnProvider.Delete(transactionManager, idLabel);
		...
		/// <summary>
		/// public virtualDeep Loads the requested <see cref="LabelNn"/> by the entity keys.  The criteria of the child 
		...
		/// <returns>Returns an instance of the <see cref="LabelNn"/> class and DeepLoaded.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual LabelNn DeepLoadByIdLabel(System.Int64 idLabel, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadByIdLabel");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			LabelNn entity = GetByIdLabel(idLabel);
		...
		/// <remarks>
		/// <seealso cref="DeepLoad(LabelNn)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(LabelNn entity)
		{
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(LabelNn entity, bool deep)
		{
		...
		/// </remarks>
		/// <param name="entity">The <see cref="LabelNn"/> object to load.</param>
		...
		/// <param name="childTypes">LabelNn Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(LabelNn entity, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			...
			try
            {
				...
				dataProvider.LabelNnProvider.DeepLoad(transactionManager, entity, deep, deepLoadType, childTypes);
		...
		/// <summary>
		/// Deep Loads the <see cref="TList{LabelNn}" /> object with all of the child 
		/// property collections only 1 Level Deep.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(LabelNn)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		/// <param name="entityCollection">the <see cref="TList{LabelNn}" /> Object to deep loads.</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<LabelNn> entityCollection)
		{
			DeepLoad(entityCollection, false, DeepLoadType.ExcludeChildren, Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Loads the <see cref="TList{LabelNn}" /> object.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(LabelNn)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<LabelNn> entityCollection, bool deep)
		{
			DeepLoad(entityCollection, deep, DeepLoadType.ExcludeChildren, Type.EmptyTypes);
		}	

		/// <summary>
		/// Deep Loads the entire <see cref="TList{LabelNn}" /> object with criteria based of the child 
		/// property collections only N Levels Deep based on the DeepLoadType.
		/// </summary>
		/// <remarks>
		/// Use this method with caution as it is possible to DeepLoad with Recursion and traverse an entire collection's object graph.
		/// </remarks>
		/// <param name="entityCollection">The <see cref="TList{LabelNn}" /> instance to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		...
		///	</param>
		/// <param name="childTypes"><see cref="LabelNn"/> Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public override void DeepLoad(TList<LabelNn> entityCollection, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{	
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoad");
			TransactionManager transactionManager = null; 
			...
			try
            {
				...
				//Call Deep Load from the Repository
				dataProvider.LabelNnProvider.DeepLoad(transactionManager, entityCollection, deep, deepLoadType, childTypes);
		...
		/// <summary>
		/// public virtualDeep Saves the <see cref="LabelNn"/> object with all of the child
		/// property collections N Levels Deep.
		/// </summary>
		/// <param name="entity">LabelNn Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(LabelNn entity)
		{
		...
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(LabelNn entity, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Save
				result = dataProvider.LabelNnProvider.DeepSave(transactionManager, entity, deepSaveType, childTypes);
		...
		/// <summary>
		/// Deep Save the entire <see cref="TList{LabelNn}" /> object with all of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection">TList{LabelNn} Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual bool DeepSave(TList<LabelNn> entityCollection)
		{
			return DeepSave(entityCollection, DeepSaveType.ExcludeChildren, Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Save the entire object graph of the <see cref="TList{LabelNn}" /> object with criteria based of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection"><see cref="TList{LabelNn}" /> Object</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">LabelNn Property Collection Type Array To Include or Exclude from Save</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(TList<LabelNn> entityCollection, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{				
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepSave");
			...
			try
            {
				...
				transactionManager = ConnectionScope.ValidateOrCreateTransaction();
				NetTiersProvider dataProvider = ConnectionScope.Current.DataProvider;
				result = dataProvider.LabelNnProvider.DeepSave(transactionManager, entityCollection,  deepSaveType, childTypes);
