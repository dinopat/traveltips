...
{		
	...
	/// All custom implementations should be done in the <see cref="Gallery"/> class.
	/// </remarks>
	[DataObject]
	[CLSCompliant(true)]
	public partial class GalleryServiceBase : ServiceBase<Gallery, GalleryKey>
	{

		#region Constructors
		///<summary>
		/// Creates a new <see cref="Gallery"/> instance .
		///</summary>
		public GalleryServiceBase() : base()
		{
		}
		...
		public static Gallery CreateGallery(System.Int64 idGallery, System.Int64? idCongTy, System.String tenAnh, System.String duongDan, System.String moTa, System.Byte? flag)
		{
			...
			newEntityGallery.MoTa  = moTa;
			newEntityGallery.Flag  = flag;
			return newEntityGallery;
		}
		#endregion Constructors


		#region Fields
		private static SecurityContext<Gallery> securityContext = new SecurityContext<Gallery>();
		...
		///</summary>
		public static SecurityContext<Gallery> SecurityContext
		{
			get
			{
		...
		/// <summary>
		/// 	public virtual method that Gets rows in a <see cref="TList{Gallery}" /> from the datasource based on the FK_tbl_Gallery_tbl_CongTy key.
		///		FK_tbl_Gallery_tbl_CongTy Description: 
		/// </summary>
		/// <param name="idCongTy"></param>
		/// <returns>Returns a generic collection of Gallery objects.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual TList<Gallery> GetByIdCongTy(System.Int64? idCongTy)
		{
			int totalCount = -1;
		...
		/// <returns>Returns a collection <see cref="TList{Gallery}" /> of <c>Gallery</c> objects.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual TList<Gallery> GetByIdCongTy(System.Int64? idCongTy, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetByIdCongTy");
			
			// get this data
			TList<Gallery> list = null;
			totalCount = -1;
            ...
            {					
				...
				//Access repository
				list = new TList<Gallery>(dataProvider.GalleryProvider.GetByIdCongTy(transactionManager, idCongTy, start, pageLength, out totalCount));
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public override Gallery Get(GalleryKey key)
		{
			return GetByIdGallery(key.IdGallery);
		}

		/// <summary>
		///  method that Gets rows in a <see cref="TList{Gallery}" /> from the datasource based on the primary key PK_tbl_Gallery index.
		/// </summary>
		/// <param name="idGallery"></param>
		/// <returns>Returns an instance of the <see cref="Gallery"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Gallery GetByIdGallery(System.Int64 idGallery)
		{
			int totalCount = -1;
			return GetByIdGallery(idGallery, 0, defaultMaxRecords, out totalCount);
		}
		...
		/// <returns>Returns an instance of the <see cref="Gallery"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Gallery GetByIdGallery(System.Int64 idGallery, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetByIdGallery");
			totalCount = -1;
            ...
            {	
				...
				//Access Repository
				entity = dataProvider.GalleryProvider.GetByIdGallery(transactionManager, idGallery, start, pageLength, out totalCount)   as Gallery;
		...
		#region GetAll
		/// <summary>
		/// Get a complete collection of <see cref="Gallery" /> entities.
		/// </summary>
		/// <returns></returns>
		public override TList<Gallery> GetAll() 
		{
			int totalCount = -1;
		...
		/// <summary>
		/// Get a set portion of a complete list of <see cref="Gallery" /> entities
		/// </summary>
		/// <param name="start">Row number at which to start reading.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="totalCount">out parameter, number of total rows in given query.</param>
		/// <returns>a <see cref="TList{Gallery}"/> </returns>
		public virtual TList<Gallery> GetAll(int start, int pageLength, out int totalCount) 
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.GalleryProvider.GetAll(transactionManager, start, pageLength, out totalCount);	
			}
            catch (Exception exc)
            {
				//if open, rollback, it's possible this is part of a  larger commit
		...
		#region GetPaged
		/// <summary>
		/// Gets a page of <see cref="TList{Gallery}" /> rows from the DataSource.
		/// </summary>
		/// <param name="totalCount">Out Parameter, Number of rows in the DataSource.</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>Gallery</c> objects.</returns>
		public virtual TList<Gallery> GetPaged(out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>Gallery</c> objects.</returns>
		public virtual TList<Gallery> GetPaged(int start, int pageLength, out int totalCount)
		{
			return GetPaged(null, null, start, pageLength, out totalCount);
		}

		/// <summary>
		/// Gets a page of entity rows with a <see cref="TList{Gallery}" /> from the DataSource with a where clause and order by clause.
		/// </summary>
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>Gallery</c> objects.</returns>
		public override TList<Gallery> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.GalleryProvider.GetPaged(transactionManager, whereClause, orderBy, start, pageLength, out totalCount);
		...
		public virtual TList<Gallery> Find(string whereClause)
		{
			int totalCount = -1;
		...
		public override TList<Gallery> Find(string whereClause, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.GalleryProvider.Find(transactionManager, whereClause, start, pageLength, out totalCount);
		...
		/// <returns>Returns a typed collection of <c>Gallery</c> objects.</returns>
		public virtual TList<Gallery> Find(IFilterParameterCollection parameters)
		{
		...
		/// <param name="orderBy">Specifies the sort criteria for the rows in the DataSource (Name ASC; BirthDay DESC, Name ASC);</param>
		/// <returns>Returns a typed collection of <c>Gallery</c> objects.</returns>
		public virtual TList<Gallery> Find(IFilterParameterCollection parameters, string orderBy)
		{
			int count = 0;
		...
		/// <returns>Returns a typed collection of <c>Gallery</c> objects.</returns>
		public virtual TList<Gallery> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				//Access repository
				list = dataProvider.GalleryProvider.Find(transactionManager, parameters, orderBy, start, pageLength, out count);
			}
            catch (Exception exc)
            {
				//if open, rollback, it's possible this is part of a larger commit
		...
		public override bool Insert(Gallery entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.GalleryProvider.Insert(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Inserts rows in <see cref="TList{Gallery}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>Gallery</c> objects in a <see cref="TList{Gallery}" /> object to Insert.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Insert)]
		public virtual TList<Gallery> Insert(TList<Gallery> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Insert");
			...
			{
				throw new Entities.EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<Gallery>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Insert
				dataProvider.GalleryProvider.Insert(transactionManager, entityCollection); 
		...
		public override bool Update(Gallery entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.GalleryProvider.Update(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Updates rows in <see cref="TList{Gallery}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>Gallery</c> objects in a <see cref="TList{Gallery}" /> object to Update.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<Gallery> Update(TList<Gallery> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Update");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<Gallery>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Update
				dataProvider.GalleryProvider.Update(transactionManager, entityCollection); 
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override Gallery Save(Gallery entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				dataProvider.GalleryProvider.Save(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Saves rows in <see cref="TList{Gallery}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>Gallery</c> objects in a <see cref="TList{Gallery}" /> object to Save.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<Gallery> Save(TList<Gallery> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Save");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<Gallery>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Save
				dataProvider.GalleryProvider.Save(transactionManager, entityCollection); 
		...
		public override bool Delete(Gallery entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.GalleryProvider.Delete(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Deletes rows in <see cref="TList{Gallery}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>Gallery</c> objects in a <see cref="TList{Gallery}" /> object to Delete.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual TList<Gallery> Delete(TList<Gallery> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<Gallery>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Delete
				dataProvider.GalleryProvider.Delete(transactionManager, entityCollection); 
		...
		public bool Delete(GalleryKey key)
		{
			return Delete(key.IdGallery );
		}
		...
		/// <returns>Returns true if operation suceeded.</returns>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual bool Delete(System.Int64 idGallery)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			try
            {
				...
				//Delete
				result = dataProvider.GalleryProvider.Delete(transactionManager, idGallery);
		...
		/// <summary>
		/// public virtualDeep Loads the requested <see cref="Gallery"/> by the entity keys.  The criteria of the child 
		...
		/// <returns>Returns an instance of the <see cref="Gallery"/> class and DeepLoaded.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Gallery DeepLoadByIdGallery(System.Int64 idGallery, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadByIdGallery");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			Gallery entity = GetByIdGallery(idGallery);
		...
		/// <remarks>
		/// <seealso cref="DeepLoad(Gallery)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(Gallery entity)
		{
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(Gallery entity, bool deep)
		{
		...
		/// </remarks>
		/// <param name="entity">The <see cref="Gallery"/> object to load.</param>
		...
		/// <param name="childTypes">Gallery Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(Gallery entity, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			...
			try
            {
				...
				dataProvider.GalleryProvider.DeepLoad(transactionManager, entity, deep, deepLoadType, childTypes);
		...
		/// <summary>
		/// Deep Loads the <see cref="TList{Gallery}" /> object with all of the child 
		/// property collections only 1 Level Deep.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(Gallery)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		/// <param name="entityCollection">the <see cref="TList{Gallery}" /> Object to deep loads.</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<Gallery> entityCollection)
		{
			DeepLoad(entityCollection, false, DeepLoadType.ExcludeChildren, Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Loads the <see cref="TList{Gallery}" /> object.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(Gallery)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<Gallery> entityCollection, bool deep)
		{
			DeepLoad(entityCollection, deep, DeepLoadType.ExcludeChildren, Type.EmptyTypes);
		}	

		/// <summary>
		/// Deep Loads the entire <see cref="TList{Gallery}" /> object with criteria based of the child 
		/// property collections only N Levels Deep based on the DeepLoadType.
		/// </summary>
		/// <remarks>
		/// Use this method with caution as it is possible to DeepLoad with Recursion and traverse an entire collection's object graph.
		/// </remarks>
		/// <param name="entityCollection">The <see cref="TList{Gallery}" /> instance to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		...
		///	</param>
		/// <param name="childTypes"><see cref="Gallery"/> Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public override void DeepLoad(TList<Gallery> entityCollection, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{	
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoad");
			TransactionManager transactionManager = null; 
			...
			try
            {
				...
				//Call Deep Load from the Repository
				dataProvider.GalleryProvider.DeepLoad(transactionManager, entityCollection, deep, deepLoadType, childTypes);
		...
		/// <summary>
		/// public virtualDeep Saves the <see cref="Gallery"/> object with all of the child
		/// property collections N Levels Deep.
		/// </summary>
		/// <param name="entity">Gallery Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(Gallery entity)
		{
		...
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(Gallery entity, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Save
				result = dataProvider.GalleryProvider.DeepSave(transactionManager, entity, deepSaveType, childTypes);
		...
		/// <summary>
		/// Deep Save the entire <see cref="TList{Gallery}" /> object with all of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection">TList{Gallery} Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual bool DeepSave(TList<Gallery> entityCollection)
		{
			return DeepSave(entityCollection, DeepSaveType.ExcludeChildren, Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Save the entire object graph of the <see cref="TList{Gallery}" /> object with criteria based of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection"><see cref="TList{Gallery}" /> Object</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">Gallery Property Collection Type Array To Include or Exclude from Save</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(TList<Gallery> entityCollection, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{				
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepSave");
			...
			try
            {
				...
				transactionManager = ConnectionScope.ValidateOrCreateTransaction();
				NetTiersProvider dataProvider = ConnectionScope.Current.DataProvider;
				result = dataProvider.GalleryProvider.DeepSave(transactionManager, entityCollection,  deepSaveType, childTypes);
