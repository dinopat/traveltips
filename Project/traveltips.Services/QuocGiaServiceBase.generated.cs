...
{		
	...
	/// All custom implementations should be done in the <see cref="QuocGia"/> class.
	/// </remarks>
	[DataObject]
	[CLSCompliant(true)]
	public partial class QuocGiaServiceBase : ServiceBase<QuocGia, QuocGiaKey>
	{

		#region Constructors
		///<summary>
		/// Creates a new <see cref="QuocGia"/> instance .
		///</summary>
		public QuocGiaServiceBase() : base()
		{
		}
		...
		public static QuocGia CreateQuocGia(System.Int64 idQuocGia, System.String tenQg, System.String maQg, System.String moTa, System.Byte? flag)
		{
			...
			newEntityQuocGia.Flag  = flag;
			return newEntityQuocGia;
		}
		#endregion Constructors


		#region Fields
		private static SecurityContext<QuocGia> securityContext = new SecurityContext<QuocGia>();
		...
		///</summary>
		public static SecurityContext<QuocGia> SecurityContext
		{
			get
			{
		...
		public override QuocGia Get(QuocGiaKey key)
		{
			return GetByIdQuocGia(key.IdQuocGia);
		}

		/// <summary>
		///  method that Gets rows in a <see cref="TList{QuocGia}" /> from the datasource based on the primary key PK_tbl_QuocGia index.
		/// </summary>
		/// <param name="idQuocGia"></param>
		/// <returns>Returns an instance of the <see cref="QuocGia"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual QuocGia GetByIdQuocGia(System.Int64 idQuocGia)
		{
			int totalCount = -1;
		...
		/// <returns>Returns an instance of the <see cref="QuocGia"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual QuocGia GetByIdQuocGia(System.Int64 idQuocGia, int start, int pageLength, out int totalCount)
		{
            ...
            {	
				...
				//Access Repository
				entity = dataProvider.QuocGiaProvider.GetByIdQuocGia(transactionManager, idQuocGia, start, pageLength, out totalCount)   as QuocGia;
		...
		#region GetAll
		/// <summary>
		/// Get a complete collection of <see cref="QuocGia" /> entities.
		/// </summary>
		/// <returns></returns>
		public override TList<QuocGia> GetAll() 
		{
			int totalCount = -1;
		...
		/// <summary>
		/// Get a set portion of a complete list of <see cref="QuocGia" /> entities
		/// </summary>
		/// <param name="start">Row number at which to start reading.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="totalCount">out parameter, number of total rows in given query.</param>
		/// <returns>a <see cref="TList{QuocGia}"/> </returns>
		public virtual TList<QuocGia> GetAll(int start, int pageLength, out int totalCount) 
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetAll");
			
			// get this data
			TList<QuocGia> list = null;
			totalCount = -1;
			TransactionManager transactionManager = null; 
            ...
            {	
				...
				//Access repository
				list = dataProvider.QuocGiaProvider.GetAll(transactionManager, start, pageLength, out totalCount);	
			}
            catch (Exception exc)
            {
				//if open, rollback, it's possible this is part of a  larger commit
		...
		#region GetPaged
		/// <summary>
		/// Gets a page of <see cref="TList{QuocGia}" /> rows from the DataSource.
		/// </summary>
		/// <param name="totalCount">Out Parameter, Number of rows in the DataSource.</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>QuocGia</c> objects.</returns>
		public virtual TList<QuocGia> GetPaged(out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>QuocGia</c> objects.</returns>
		public virtual TList<QuocGia> GetPaged(int start, int pageLength, out int totalCount)
		{
			return GetPaged(null, null, start, pageLength, out totalCount);
		}

		/// <summary>
		/// Gets a page of entity rows with a <see cref="TList{QuocGia}" /> from the DataSource with a where clause and order by clause.
		/// </summary>
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>QuocGia</c> objects.</returns>
		public override TList<QuocGia> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.QuocGiaProvider.GetPaged(transactionManager, whereClause, orderBy, start, pageLength, out totalCount);
		...
		public virtual TList<QuocGia> Find(string whereClause)
		{
			int totalCount = -1;
		...
		public override TList<QuocGia> Find(string whereClause, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.QuocGiaProvider.Find(transactionManager, whereClause, start, pageLength, out totalCount);
		...
		/// <returns>Returns a typed collection of <c>QuocGia</c> objects.</returns>
		public virtual TList<QuocGia> Find(IFilterParameterCollection parameters)
		{
		...
		/// <param name="orderBy">Specifies the sort criteria for the rows in the DataSource (Name ASC; BirthDay DESC, Name ASC);</param>
		/// <returns>Returns a typed collection of <c>QuocGia</c> objects.</returns>
		public virtual TList<QuocGia> Find(IFilterParameterCollection parameters, string orderBy)
		{
			int count = 0;
		...
		/// <returns>Returns a typed collection of <c>QuocGia</c> objects.</returns>
		public virtual TList<QuocGia> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				//Access repository
				list = dataProvider.QuocGiaProvider.Find(transactionManager, parameters, orderBy, start, pageLength, out count);
			}
            catch (Exception exc)
            {
				//if open, rollback, it's possible this is part of a larger commit
		...
		public override bool Insert(QuocGia entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.QuocGiaProvider.Insert(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Inserts rows in <see cref="TList{QuocGia}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>QuocGia</c> objects in a <see cref="TList{QuocGia}" /> object to Insert.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Insert)]
		public virtual TList<QuocGia> Insert(TList<QuocGia> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Insert");
			...
			{
				throw new Entities.EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<QuocGia>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Insert
				dataProvider.QuocGiaProvider.Insert(transactionManager, entityCollection); 
		...
		public override bool Update(QuocGia entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.QuocGiaProvider.Update(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Updates rows in <see cref="TList{QuocGia}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>QuocGia</c> objects in a <see cref="TList{QuocGia}" /> object to Update.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<QuocGia> Update(TList<QuocGia> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Update");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<QuocGia>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Update
				dataProvider.QuocGiaProvider.Update(transactionManager, entityCollection); 
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override QuocGia Save(QuocGia entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				dataProvider.QuocGiaProvider.Save(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Saves rows in <see cref="TList{QuocGia}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>QuocGia</c> objects in a <see cref="TList{QuocGia}" /> object to Save.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<QuocGia> Save(TList<QuocGia> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Save");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<QuocGia>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Save
				dataProvider.QuocGiaProvider.Save(transactionManager, entityCollection); 
		...
		public override bool Delete(QuocGia entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.QuocGiaProvider.Delete(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Deletes rows in <see cref="TList{QuocGia}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>QuocGia</c> objects in a <see cref="TList{QuocGia}" /> object to Delete.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual TList<QuocGia> Delete(TList<QuocGia> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<QuocGia>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Delete
				dataProvider.QuocGiaProvider.Delete(transactionManager, entityCollection); 
		...
		public bool Delete(QuocGiaKey key)
		{
			return Delete(key.IdQuocGia );
		}
		...
		/// <returns>Returns true if operation suceeded.</returns>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual bool Delete(System.Int64 idQuocGia)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			try
            {
				...
				//Delete
				result = dataProvider.QuocGiaProvider.Delete(transactionManager, idQuocGia);
		...
		/// <summary>
		/// public virtualDeep Loads the requested <see cref="QuocGia"/> by the entity keys.  The criteria of the child 
		...
		/// <returns>Returns an instance of the <see cref="QuocGia"/> class and DeepLoaded.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual QuocGia DeepLoadByIdQuocGia(System.Int64 idQuocGia, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadByIdQuocGia");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			QuocGia entity = GetByIdQuocGia(idQuocGia);
		...
		/// <remarks>
		/// <seealso cref="DeepLoad(QuocGia)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(QuocGia entity)
		{
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(QuocGia entity, bool deep)
		{
		...
		/// </remarks>
		/// <param name="entity">The <see cref="QuocGia"/> object to load.</param>
		...
		/// <param name="childTypes">QuocGia Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(QuocGia entity, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			...
			try
            {
				...
				dataProvider.QuocGiaProvider.DeepLoad(transactionManager, entity, deep, deepLoadType, childTypes);
		...
		/// <summary>
		/// Deep Loads the <see cref="TList{QuocGia}" /> object with all of the child 
		/// property collections only 1 Level Deep.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(QuocGia)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		/// <param name="entityCollection">the <see cref="TList{QuocGia}" /> Object to deep loads.</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<QuocGia> entityCollection)
		{
			DeepLoad(entityCollection, false, DeepLoadType.ExcludeChildren, Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Loads the <see cref="TList{QuocGia}" /> object.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(QuocGia)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<QuocGia> entityCollection, bool deep)
		{
			DeepLoad(entityCollection, deep, DeepLoadType.ExcludeChildren, Type.EmptyTypes);
		}	

		/// <summary>
		/// Deep Loads the entire <see cref="TList{QuocGia}" /> object with criteria based of the child 
		/// property collections only N Levels Deep based on the DeepLoadType.
		/// </summary>
		/// <remarks>
		/// Use this method with caution as it is possible to DeepLoad with Recursion and traverse an entire collection's object graph.
		/// </remarks>
		/// <param name="entityCollection">The <see cref="TList{QuocGia}" /> instance to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		...
		///	</param>
		/// <param name="childTypes"><see cref="QuocGia"/> Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public override void DeepLoad(TList<QuocGia> entityCollection, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{	
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoad");
			TransactionManager transactionManager = null; 
			...
			try
            {
				...
				//Call Deep Load from the Repository
				dataProvider.QuocGiaProvider.DeepLoad(transactionManager, entityCollection, deep, deepLoadType, childTypes);
		...
		/// <summary>
		/// public virtualDeep Saves the <see cref="QuocGia"/> object with all of the child
		/// property collections N Levels Deep.
		/// </summary>
		/// <param name="entity">QuocGia Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(QuocGia entity)
		{
		...
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(QuocGia entity, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Save
				result = dataProvider.QuocGiaProvider.DeepSave(transactionManager, entity, deepSaveType, childTypes);
		...
		/// <summary>
		/// Deep Save the entire <see cref="TList{QuocGia}" /> object with all of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection">TList{QuocGia} Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual bool DeepSave(TList<QuocGia> entityCollection)
		{
			return DeepSave(entityCollection, DeepSaveType.ExcludeChildren, Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Save the entire object graph of the <see cref="TList{QuocGia}" /> object with criteria based of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection"><see cref="TList{QuocGia}" /> Object</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">QuocGia Property Collection Type Array To Include or Exclude from Save</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(TList<QuocGia> entityCollection, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{				
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepSave");
			...
			try
            {
				...
				transactionManager = ConnectionScope.ValidateOrCreateTransaction();
				NetTiersProvider dataProvider = ConnectionScope.Current.DataProvider;
				result = dataProvider.QuocGiaProvider.DeepSave(transactionManager, entityCollection,  deepSaveType, childTypes);
