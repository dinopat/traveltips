...
{		
	...
	public partial class LanguageServiceBase : ServiceBase<Language, LanguageKey>
	{
		...
		{
			return GetByIdLanguage(key.IdLanguage);
		}

		/// <summary>
		///  method that Gets rows in a <see cref="TList{Language}" /> from the datasource based on the primary key PK_tbl_Language index.
		/// </summary>
		/// <param name="idLanguage"></param>
		/// <returns>Returns an instance of the <see cref="Language"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Language GetByIdLanguage(System.Int32 idLanguage)
		{
			int totalCount = -1;
		...
		/// <returns>Returns an instance of the <see cref="Language"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Language GetByIdLanguage(System.Int32 idLanguage, int start, int pageLength, out int totalCount)
		{
            ...
            {	
				...
				//Access Repository
				entity = dataProvider.LanguageProvider.GetByIdLanguage(transactionManager, idLanguage, start, pageLength, out totalCount)   as Language;
		...
		/// <returns>Returns true if operation suceeded.</returns>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual bool Delete(System.Int32 idLanguage)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			try
            {
				...
				//Delete
				result = dataProvider.LanguageProvider.Delete(transactionManager, idLanguage);
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Language DeepLoadByIdLanguage(System.Int32 idLanguage, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadByIdLanguage");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			Language entity = GetByIdLanguage(idLanguage);
