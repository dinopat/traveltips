...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>AdminRepeater</c>
    /// </summary>
	public class AdminRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:AdminRepeaterDesigner"/> class.
        /// </summary>
		public AdminRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is AdminRepeater))
			{ 
				throw new ArgumentException("Component is not a AdminRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			AdminRepeater z = (AdminRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <c cref="AdminRepeater"></c> Type.
    /// </summary>
	[Designer(typeof(AdminRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:AdminRepeater runat=\"server\"></{0}:AdminRepeater>")]
	public class AdminRepeater : Control, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:AdminRepeater"/> class.
        /// </summary>
		public AdminRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(AdminItem))]
		...
		private System.Collections.IEnumerable ConnectToDataSourceView()
		{
			...
			{
				traveltips.Web.Data.AdminDataSource datasource = null;
            ...
            if (ctl == null)
            {
               ...
               if (ctl == null)
               {
				...
				datasource = ctl as traveltips.Web.Data.AdminDataSource;
				if (datasource == null)
				{
		...
		protected override void CreateChildControls()
		{
			...
			if (datas != null)
			{
				...
				{
					traveltips.Entities.Admin entity = o as traveltips.Entities.Admin;
					AdminItem container = new AdminItem(entity);
	...
	public class AdminItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private traveltips.Entities.Admin _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:AdminItem"/> class.
        /// </summary>
		public AdminItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:AdminItem"/> class.
        /// </summary>
		public AdminItem(traveltips.Entities.Admin entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// Gets the IdAdmin
        /// </summary>
        /// <value>The IdAdmin.</value>
		[System.ComponentModel.Bindable(true)]
		public System.Int64 IdAdmin
		{
			get { return _entity.IdAdmin; }
		}
        /// <summary>
        ...
        /// <summary>
        /// Gets a <see cref="T:traveltips.Entities.Admin"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public traveltips.Entities.Admin Entity
        {
            get { return _entity; }
        }
	}
