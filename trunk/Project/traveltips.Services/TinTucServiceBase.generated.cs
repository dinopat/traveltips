...
{		
	...
	/// All custom implementations should be done in the <see cref="TinTuc"/> class.
	/// </remarks>
	[DataObject]
	[CLSCompliant(true)]
	public partial class TinTucServiceBase : ServiceBase<TinTuc, TinTucKey>
	{

		#region Constructors
		///<summary>
		/// Creates a new <see cref="TinTuc"/> instance .
		///</summary>
		public TinTucServiceBase() : base()
		{
		}
		...
		public static TinTuc CreateTinTuc(System.Int64 idTinTuc, System.Int64? idCongTy, System.String tieuDe, System.String moTaNgan, System.String moTaChiTiet, System.Boolean? khuyenMai, System.Byte? flag)
		{
			...
			newEntityTinTuc.MoTaChiTiet  = moTaChiTiet;
			newEntityTinTuc.KhuyenMai  = khuyenMai;
			newEntityTinTuc.Flag  = flag;
			return newEntityTinTuc;
		}
		#endregion Constructors


		#region Fields
		private static SecurityContext<TinTuc> securityContext = new SecurityContext<TinTuc>();
		...
		///</summary>
		public static SecurityContext<TinTuc> SecurityContext
		{
			get
			{
		...
		/// <summary>
		/// 	public virtual method that Gets rows in a <see cref="TList{TinTuc}" /> from the datasource based on the FK_tbl_TinTuc_tbl_CongTy key.
		///		FK_tbl_TinTuc_tbl_CongTy Description: 
		/// </summary>
		/// <param name="idCongTy"></param>
		/// <returns>Returns a generic collection of TinTuc objects.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual TList<TinTuc> GetByIdCongTy(System.Int64? idCongTy)
		{
			int totalCount = -1;
		...
		/// <returns>Returns a collection <see cref="TList{TinTuc}" /> of <c>TinTuc</c> objects.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual TList<TinTuc> GetByIdCongTy(System.Int64? idCongTy, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetByIdCongTy");
			
			// get this data
			TList<TinTuc> list = null;
			totalCount = -1;
            ...
            {					
				...
				//Access repository
				list = new TList<TinTuc>(dataProvider.TinTucProvider.GetByIdCongTy(transactionManager, idCongTy, start, pageLength, out totalCount));
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public override TinTuc Get(TinTucKey key)
		{
			return GetByIdTinTuc(key.IdTinTuc);
		}

		/// <summary>
		///  method that Gets rows in a <see cref="TList{TinTuc}" /> from the datasource based on the primary key PK_tbl_TinTuc index.
		/// </summary>
		/// <param name="idTinTuc"></param>
		/// <returns>Returns an instance of the <see cref="TinTuc"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual TinTuc GetByIdTinTuc(System.Int64 idTinTuc)
		{
			int totalCount = -1;
			return GetByIdTinTuc(idTinTuc, 0, defaultMaxRecords, out totalCount);
		}
		...
		/// <returns>Returns an instance of the <see cref="TinTuc"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual TinTuc GetByIdTinTuc(System.Int64 idTinTuc, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetByIdTinTuc");
			totalCount = -1;
            ...
            {	
				...
				//Access Repository
				entity = dataProvider.TinTucProvider.GetByIdTinTuc(transactionManager, idTinTuc, start, pageLength, out totalCount)   as TinTuc;
		...
		#region GetAll
		/// <summary>
		/// Get a complete collection of <see cref="TinTuc" /> entities.
		/// </summary>
		/// <returns></returns>
		public override TList<TinTuc> GetAll() 
		{
			int totalCount = -1;
		...
		/// <summary>
		/// Get a set portion of a complete list of <see cref="TinTuc" /> entities
		/// </summary>
		/// <param name="start">Row number at which to start reading.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="totalCount">out parameter, number of total rows in given query.</param>
		/// <returns>a <see cref="TList{TinTuc}"/> </returns>
		public virtual TList<TinTuc> GetAll(int start, int pageLength, out int totalCount) 
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.TinTucProvider.GetAll(transactionManager, start, pageLength, out totalCount);	
			}
            catch (Exception exc)
            {
				//if open, rollback, it's possible this is part of a  larger commit
		...
		#region GetPaged
		/// <summary>
		/// Gets a page of <see cref="TList{TinTuc}" /> rows from the DataSource.
		/// </summary>
		/// <param name="totalCount">Out Parameter, Number of rows in the DataSource.</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>TinTuc</c> objects.</returns>
		public virtual TList<TinTuc> GetPaged(out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>TinTuc</c> objects.</returns>
		public virtual TList<TinTuc> GetPaged(int start, int pageLength, out int totalCount)
		{
			return GetPaged(null, null, start, pageLength, out totalCount);
		}

		/// <summary>
		/// Gets a page of entity rows with a <see cref="TList{TinTuc}" /> from the DataSource with a where clause and order by clause.
		/// </summary>
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>TinTuc</c> objects.</returns>
		public override TList<TinTuc> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.TinTucProvider.GetPaged(transactionManager, whereClause, orderBy, start, pageLength, out totalCount);
		...
		public virtual TList<TinTuc> Find(string whereClause)
		{
			int totalCount = -1;
		...
		public override TList<TinTuc> Find(string whereClause, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.TinTucProvider.Find(transactionManager, whereClause, start, pageLength, out totalCount);
		...
		/// <returns>Returns a typed collection of <c>TinTuc</c> objects.</returns>
		public virtual TList<TinTuc> Find(IFilterParameterCollection parameters)
		{
		...
		/// <param name="orderBy">Specifies the sort criteria for the rows in the DataSource (Name ASC; BirthDay DESC, Name ASC);</param>
		/// <returns>Returns a typed collection of <c>TinTuc</c> objects.</returns>
		public virtual TList<TinTuc> Find(IFilterParameterCollection parameters, string orderBy)
		{
			int count = 0;
		...
		/// <returns>Returns a typed collection of <c>TinTuc</c> objects.</returns>
		public virtual TList<TinTuc> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				//Access repository
				list = dataProvider.TinTucProvider.Find(transactionManager, parameters, orderBy, start, pageLength, out count);
			}
            catch (Exception exc)
            {
				//if open, rollback, it's possible this is part of a larger commit
		...
		public override bool Insert(TinTuc entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.TinTucProvider.Insert(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Inserts rows in <see cref="TList{TinTuc}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>TinTuc</c> objects in a <see cref="TList{TinTuc}" /> object to Insert.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Insert)]
		public virtual TList<TinTuc> Insert(TList<TinTuc> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Insert");
			...
			{
				throw new Entities.EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<TinTuc>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Insert
				dataProvider.TinTucProvider.Insert(transactionManager, entityCollection); 
		...
		public override bool Update(TinTuc entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.TinTucProvider.Update(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Updates rows in <see cref="TList{TinTuc}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>TinTuc</c> objects in a <see cref="TList{TinTuc}" /> object to Update.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<TinTuc> Update(TList<TinTuc> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Update");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<TinTuc>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Update
				dataProvider.TinTucProvider.Update(transactionManager, entityCollection); 
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override TinTuc Save(TinTuc entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				dataProvider.TinTucProvider.Save(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Saves rows in <see cref="TList{TinTuc}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>TinTuc</c> objects in a <see cref="TList{TinTuc}" /> object to Save.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<TinTuc> Save(TList<TinTuc> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Save");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<TinTuc>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Save
				dataProvider.TinTucProvider.Save(transactionManager, entityCollection); 
		...
		public override bool Delete(TinTuc entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.TinTucProvider.Delete(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Deletes rows in <see cref="TList{TinTuc}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>TinTuc</c> objects in a <see cref="TList{TinTuc}" /> object to Delete.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual TList<TinTuc> Delete(TList<TinTuc> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<TinTuc>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Delete
				dataProvider.TinTucProvider.Delete(transactionManager, entityCollection); 
		...
		public bool Delete(TinTucKey key)
		{
			return Delete(key.IdTinTuc );
		}
		...
		/// <returns>Returns true if operation suceeded.</returns>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual bool Delete(System.Int64 idTinTuc)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			try
            {
				...
				//Delete
				result = dataProvider.TinTucProvider.Delete(transactionManager, idTinTuc);
		...
		/// <summary>
		/// public virtualDeep Loads the requested <see cref="TinTuc"/> by the entity keys.  The criteria of the child 
		...
		/// <returns>Returns an instance of the <see cref="TinTuc"/> class and DeepLoaded.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual TinTuc DeepLoadByIdTinTuc(System.Int64 idTinTuc, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadByIdTinTuc");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			TinTuc entity = GetByIdTinTuc(idTinTuc);
		...
		/// <remarks>
		/// <seealso cref="DeepLoad(TinTuc)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TinTuc entity)
		{
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TinTuc entity, bool deep)
		{
		...
		/// </remarks>
		/// <param name="entity">The <see cref="TinTuc"/> object to load.</param>
		...
		/// <param name="childTypes">TinTuc Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TinTuc entity, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			...
			try
            {
				...
				dataProvider.TinTucProvider.DeepLoad(transactionManager, entity, deep, deepLoadType, childTypes);
		...
		/// <summary>
		/// Deep Loads the <see cref="TList{TinTuc}" /> object with all of the child 
		/// property collections only 1 Level Deep.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(TinTuc)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		/// <param name="entityCollection">the <see cref="TList{TinTuc}" /> Object to deep loads.</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<TinTuc> entityCollection)
		{
			DeepLoad(entityCollection, false, DeepLoadType.ExcludeChildren, Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Loads the <see cref="TList{TinTuc}" /> object.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(TinTuc)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<TinTuc> entityCollection, bool deep)
		{
			DeepLoad(entityCollection, deep, DeepLoadType.ExcludeChildren, Type.EmptyTypes);
		}	

		/// <summary>
		/// Deep Loads the entire <see cref="TList{TinTuc}" /> object with criteria based of the child 
		/// property collections only N Levels Deep based on the DeepLoadType.
		/// </summary>
		/// <remarks>
		/// Use this method with caution as it is possible to DeepLoad with Recursion and traverse an entire collection's object graph.
		/// </remarks>
		/// <param name="entityCollection">The <see cref="TList{TinTuc}" /> instance to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		...
		///	</param>
		/// <param name="childTypes"><see cref="TinTuc"/> Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public override void DeepLoad(TList<TinTuc> entityCollection, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{	
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoad");
			TransactionManager transactionManager = null; 
			...
			try
            {
				...
				//Call Deep Load from the Repository
				dataProvider.TinTucProvider.DeepLoad(transactionManager, entityCollection, deep, deepLoadType, childTypes);
		...
		/// <summary>
		/// public virtualDeep Saves the <see cref="TinTuc"/> object with all of the child
		/// property collections N Levels Deep.
		/// </summary>
		/// <param name="entity">TinTuc Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(TinTuc entity)
		{
		...
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(TinTuc entity, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Save
				result = dataProvider.TinTucProvider.DeepSave(transactionManager, entity, deepSaveType, childTypes);
		...
		/// <summary>
		/// Deep Save the entire <see cref="TList{TinTuc}" /> object with all of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection">TList{TinTuc} Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual bool DeepSave(TList<TinTuc> entityCollection)
		{
			return DeepSave(entityCollection, DeepSaveType.ExcludeChildren, Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Save the entire object graph of the <see cref="TList{TinTuc}" /> object with criteria based of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection"><see cref="TList{TinTuc}" /> Object</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">TinTuc Property Collection Type Array To Include or Exclude from Save</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(TList<TinTuc> entityCollection, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{				
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepSave");
			...
			try
            {
				...
				transactionManager = ConnectionScope.ValidateOrCreateTransaction();
				NetTiersProvider dataProvider = ConnectionScope.Current.DataProvider;
				result = dataProvider.TinTucProvider.DeepSave(transactionManager, entityCollection,  deepSaveType, childTypes);
