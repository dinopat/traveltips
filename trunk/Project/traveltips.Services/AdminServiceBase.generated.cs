...
{		
	...
	/// All custom implementations should be done in the <see cref="Admin"/> class.
	/// </remarks>
	[DataObject]
	[CLSCompliant(true)]
	public partial class AdminServiceBase : ServiceBase<Admin, AdminKey>
	{

		#region Constructors
		///<summary>
		/// Creates a new <see cref="Admin"/> instance .
		///</summary>
		public AdminServiceBase() : base()
		{
		}
		...
		public static Admin CreateAdmin(System.Int64 idAdmin, System.String tenDangNhap, System.String email, System.String password, System.String hoTen, System.String dienThoai, System.Byte? flag)
		{
			...
			newEntityAdmin.HoTen  = hoTen;
			newEntityAdmin.DienThoai  = dienThoai;
			newEntityAdmin.Flag  = flag;
			return newEntityAdmin;
		}
		#endregion Constructors


		#region Fields
		private static SecurityContext<Admin> securityContext = new SecurityContext<Admin>();
		...
		///</summary>
		public static SecurityContext<Admin> SecurityContext
		{
			get
			{
		...
		public override Admin Get(AdminKey key)
		{
			return GetByIdAdmin(key.IdAdmin);
		}

		/// <summary>
		///  method that Gets rows in a <see cref="TList{Admin}" /> from the datasource based on the primary key PK_tbl_Admin index.
		/// </summary>
		/// <param name="idAdmin"></param>
		/// <returns>Returns an instance of the <see cref="Admin"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Admin GetByIdAdmin(System.Int64 idAdmin)
		{
			int totalCount = -1;
			return GetByIdAdmin(idAdmin, 0, defaultMaxRecords, out totalCount);
		}
		...
		/// <returns>Returns an instance of the <see cref="Admin"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Admin GetByIdAdmin(System.Int64 idAdmin, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetByIdAdmin");
			totalCount = -1;
            ...
            {	
				...
				//Access Repository
				entity = dataProvider.AdminProvider.GetByIdAdmin(transactionManager, idAdmin, start, pageLength, out totalCount)   as Admin;
		...
		#region GetAll
		/// <summary>
		/// Get a complete collection of <see cref="Admin" /> entities.
		/// </summary>
		/// <returns></returns>
		public override TList<Admin> GetAll() 
		{
			int totalCount = -1;
		...
		/// <summary>
		/// Get a set portion of a complete list of <see cref="Admin" /> entities
		/// </summary>
		/// <param name="start">Row number at which to start reading.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="totalCount">out parameter, number of total rows in given query.</param>
		/// <returns>a <see cref="TList{Admin}"/> </returns>
		public virtual TList<Admin> GetAll(int start, int pageLength, out int totalCount) 
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetAll");
			
			// get this data
			TList<Admin> list = null;
			totalCount = -1;
			TransactionManager transactionManager = null; 
            ...
            {	
				...
				//Access repository
				list = dataProvider.AdminProvider.GetAll(transactionManager, start, pageLength, out totalCount);	
			}
            catch (Exception exc)
            {
				//if open, rollback, it's possible this is part of a  larger commit
		...
		#region GetPaged
		/// <summary>
		/// Gets a page of <see cref="TList{Admin}" /> rows from the DataSource.
		/// </summary>
		/// <param name="totalCount">Out Parameter, Number of rows in the DataSource.</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>Admin</c> objects.</returns>
		public virtual TList<Admin> GetPaged(out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>Admin</c> objects.</returns>
		public virtual TList<Admin> GetPaged(int start, int pageLength, out int totalCount)
		{
			return GetPaged(null, null, start, pageLength, out totalCount);
		}

		/// <summary>
		/// Gets a page of entity rows with a <see cref="TList{Admin}" /> from the DataSource with a where clause and order by clause.
		/// </summary>
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>Admin</c> objects.</returns>
		public override TList<Admin> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.AdminProvider.GetPaged(transactionManager, whereClause, orderBy, start, pageLength, out totalCount);
		...
		public virtual TList<Admin> Find(string whereClause)
		{
			int totalCount = -1;
		...
		public override TList<Admin> Find(string whereClause, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.AdminProvider.Find(transactionManager, whereClause, start, pageLength, out totalCount);
		...
		/// <returns>Returns a typed collection of <c>Admin</c> objects.</returns>
		public virtual TList<Admin> Find(IFilterParameterCollection parameters)
		{
		...
		/// <param name="orderBy">Specifies the sort criteria for the rows in the DataSource (Name ASC; BirthDay DESC, Name ASC);</param>
		/// <returns>Returns a typed collection of <c>Admin</c> objects.</returns>
		public virtual TList<Admin> Find(IFilterParameterCollection parameters, string orderBy)
		{
			int count = 0;
		...
		/// <returns>Returns a typed collection of <c>Admin</c> objects.</returns>
		public virtual TList<Admin> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				//Access repository
				list = dataProvider.AdminProvider.Find(transactionManager, parameters, orderBy, start, pageLength, out count);
			}
            catch (Exception exc)
            {
				//if open, rollback, it's possible this is part of a larger commit
		...
		public override bool Insert(Admin entity)
		{
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.AdminProvider.Insert(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Inserts rows in <see cref="TList{Admin}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>Admin</c> objects in a <see cref="TList{Admin}" /> object to Insert.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Insert)]
		public virtual TList<Admin> Insert(TList<Admin> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Insert");
			...
			{
				throw new Entities.EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<Admin>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Insert
				dataProvider.AdminProvider.Insert(transactionManager, entityCollection); 
		...
		public override bool Update(Admin entity)
		{
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.AdminProvider.Update(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Updates rows in <see cref="TList{Admin}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>Admin</c> objects in a <see cref="TList{Admin}" /> object to Update.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<Admin> Update(TList<Admin> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Update");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<Admin>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Update
				dataProvider.AdminProvider.Update(transactionManager, entityCollection); 
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override Admin Save(Admin entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				dataProvider.AdminProvider.Save(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Saves rows in <see cref="TList{Admin}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>Admin</c> objects in a <see cref="TList{Admin}" /> object to Save.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<Admin> Save(TList<Admin> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Save");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<Admin>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Save
				dataProvider.AdminProvider.Save(transactionManager, entityCollection); 
		...
		public override bool Delete(Admin entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.AdminProvider.Delete(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Deletes rows in <see cref="TList{Admin}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>Admin</c> objects in a <see cref="TList{Admin}" /> object to Delete.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual TList<Admin> Delete(TList<Admin> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<Admin>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Delete
				dataProvider.AdminProvider.Delete(transactionManager, entityCollection); 
		...
		public bool Delete(AdminKey key)
		{
			return Delete(key.IdAdmin );
		}
		...
		/// <returns>Returns true if operation suceeded.</returns>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual bool Delete(System.Int64 idAdmin)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			try
            {
				...
				//Delete
				result = dataProvider.AdminProvider.Delete(transactionManager, idAdmin);
		...
		/// <summary>
		/// public virtualDeep Loads the requested <see cref="Admin"/> by the entity keys.  The criteria of the child 
		...
		/// <returns>Returns an instance of the <see cref="Admin"/> class and DeepLoaded.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Admin DeepLoadByIdAdmin(System.Int64 idAdmin, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadByIdAdmin");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			Admin entity = GetByIdAdmin(idAdmin);
		...
		/// <remarks>
		/// <seealso cref="DeepLoad(Admin)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(Admin entity)
		{
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(Admin entity, bool deep)
		{
		...
		/// </remarks>
		/// <param name="entity">The <see cref="Admin"/> object to load.</param>
		...
		/// <param name="childTypes">Admin Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(Admin entity, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			...
			try
            {
				...
				dataProvider.AdminProvider.DeepLoad(transactionManager, entity, deep, deepLoadType, childTypes);
		...
		/// <summary>
		/// Deep Loads the <see cref="TList{Admin}" /> object with all of the child 
		/// property collections only 1 Level Deep.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(Admin)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		/// <param name="entityCollection">the <see cref="TList{Admin}" /> Object to deep loads.</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<Admin> entityCollection)
		{
			DeepLoad(entityCollection, false, DeepLoadType.ExcludeChildren, Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Loads the <see cref="TList{Admin}" /> object.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(Admin)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<Admin> entityCollection, bool deep)
		{
			DeepLoad(entityCollection, deep, DeepLoadType.ExcludeChildren, Type.EmptyTypes);
		}	

		/// <summary>
		/// Deep Loads the entire <see cref="TList{Admin}" /> object with criteria based of the child 
		/// property collections only N Levels Deep based on the DeepLoadType.
		/// </summary>
		/// <remarks>
		/// Use this method with caution as it is possible to DeepLoad with Recursion and traverse an entire collection's object graph.
		/// </remarks>
		/// <param name="entityCollection">The <see cref="TList{Admin}" /> instance to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		...
		///	</param>
		/// <param name="childTypes"><see cref="Admin"/> Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public override void DeepLoad(TList<Admin> entityCollection, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{	
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoad");
			TransactionManager transactionManager = null; 
			...
			try
            {
				...
				//Call Deep Load from the Repository
				dataProvider.AdminProvider.DeepLoad(transactionManager, entityCollection, deep, deepLoadType, childTypes);
		...
		/// <summary>
		/// public virtualDeep Saves the <see cref="Admin"/> object with all of the child
		/// property collections N Levels Deep.
		/// </summary>
		/// <param name="entity">Admin Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(Admin entity)
		{
		...
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(Admin entity, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Save
				result = dataProvider.AdminProvider.DeepSave(transactionManager, entity, deepSaveType, childTypes);
		...
		/// <summary>
		/// Deep Save the entire <see cref="TList{Admin}" /> object with all of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection">TList{Admin} Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual bool DeepSave(TList<Admin> entityCollection)
		{
			return DeepSave(entityCollection, DeepSaveType.ExcludeChildren, Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Save the entire object graph of the <see cref="TList{Admin}" /> object with criteria based of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection"><see cref="TList{Admin}" /> Object</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">Admin Property Collection Type Array To Include or Exclude from Save</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(TList<Admin> entityCollection, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{				
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepSave");
			...
			try
            {
				...
				transactionManager = ConnectionScope.ValidateOrCreateTransaction();
				NetTiersProvider dataProvider = ConnectionScope.Current.DataProvider;
				result = dataProvider.AdminProvider.DeepSave(transactionManager, entityCollection,  deepSaveType, childTypes);
