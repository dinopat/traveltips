...
{		
	...
	/// All custom implementations should be done in the <see cref="SanPham"/> class.
	/// </remarks>
	[DataObject]
	[CLSCompliant(true)]
	public partial class SanPhamServiceBase : ServiceBase<SanPham, SanPhamKey>
	{

		#region Constructors
		///<summary>
		/// Creates a new <see cref="SanPham"/> instance .
		///</summary>
		public SanPhamServiceBase() : base()
		{
		}
		...
		public static SanPham CreateSanPham(System.Int64? idCongTy, System.Int64? idLoaiSp, System.Int64? idTuDien, System.String tenSp, System.String maSp, System.Decimal? gia, System.String moTaNgan, System.String moTaChiTiet, System.Byte[] anhMinhHoa, System.Byte? flag)
		{
			...
			newEntitySanPham.TenSp  = tenSp;
			newEntitySanPham.MaSp  = maSp;
			newEntitySanPham.Gia  = gia;
			newEntitySanPham.MoTaNgan  = moTaNgan;
			newEntitySanPham.MoTaChiTiet  = moTaChiTiet;
			newEntitySanPham.AnhMinhHoa  = anhMinhHoa;
			newEntitySanPham.Flag  = flag;
			return newEntitySanPham;
		}
		#endregion Constructors


		#region Fields
		private static SecurityContext<SanPham> securityContext = new SecurityContext<SanPham>();
		...
		///</summary>
		public static SecurityContext<SanPham> SecurityContext
		{
			get
			{
		...
		/// <summary>
		/// 	public virtual method that Gets rows in a <see cref="TList{SanPham}" /> from the datasource based on the FK_tbl_SanPham_tbl_LoaiSP key.
		///		FK_tbl_SanPham_tbl_LoaiSP Description: 
		/// </summary>
		/// <param name="idLoaiSp"></param>
		/// <returns>Returns a generic collection of SanPham objects.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual TList<SanPham> GetByIdLoaiSp(System.Int64? idLoaiSp)
		{
			int totalCount = -1;
			return GetByIdLoaiSp(idLoaiSp, 0, defaultMaxRecords, out totalCount);
		}
		...
		/// <returns>Returns a collection <see cref="TList{SanPham}" /> of <c>SanPham</c> objects.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual TList<SanPham> GetByIdLoaiSp(System.Int64? idLoaiSp, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetByIdLoaiSp");
			
			// get this data
			TList<SanPham> list = null;
			totalCount = -1;
            ...
            {					
				...
				//Access repository
				list = new TList<SanPham>(dataProvider.SanPhamProvider.GetByIdLoaiSp(transactionManager, idLoaiSp, start, pageLength, out totalCount));
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public override SanPham Get(SanPhamKey key)
		{
			return GetByIdSanPham(key.IdSanPham);
		}

		/// <summary>
		///  method that Gets rows in a <see cref="TList{SanPham}" /> from the datasource based on the primary key PK_tbl_SanPham index.
		/// </summary>
		/// <param name="idSanPham"></param>
		/// <returns>Returns an instance of the <see cref="SanPham"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual SanPham GetByIdSanPham(System.Int64 idSanPham)
		{
			int totalCount = -1;
		...
		/// <returns>Returns an instance of the <see cref="SanPham"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual SanPham GetByIdSanPham(System.Int64 idSanPham, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access Repository
				entity = dataProvider.SanPhamProvider.GetByIdSanPham(transactionManager, idSanPham, start, pageLength, out totalCount)   as SanPham;
		...
		#region GetAll
		/// <summary>
		/// Get a complete collection of <see cref="SanPham" /> entities.
		/// </summary>
		/// <returns></returns>
		public override TList<SanPham> GetAll() 
		{
			int totalCount = -1;
		...
		/// <summary>
		/// Get a set portion of a complete list of <see cref="SanPham" /> entities
		/// </summary>
		/// <param name="start">Row number at which to start reading.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="totalCount">out parameter, number of total rows in given query.</param>
		/// <returns>a <see cref="TList{SanPham}"/> </returns>
		public virtual TList<SanPham> GetAll(int start, int pageLength, out int totalCount) 
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.SanPhamProvider.GetAll(transactionManager, start, pageLength, out totalCount);	
			}
            catch (Exception exc)
            {
				//if open, rollback, it's possible this is part of a  larger commit
		...
		#region GetPaged
		/// <summary>
		/// Gets a page of <see cref="TList{SanPham}" /> rows from the DataSource.
		/// </summary>
		/// <param name="totalCount">Out Parameter, Number of rows in the DataSource.</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>SanPham</c> objects.</returns>
		public virtual TList<SanPham> GetPaged(out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>SanPham</c> objects.</returns>
		public virtual TList<SanPham> GetPaged(int start, int pageLength, out int totalCount)
		{
			return GetPaged(null, null, start, pageLength, out totalCount);
		}

		/// <summary>
		/// Gets a page of entity rows with a <see cref="TList{SanPham}" /> from the DataSource with a where clause and order by clause.
		/// </summary>
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>SanPham</c> objects.</returns>
		public override TList<SanPham> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.SanPhamProvider.GetPaged(transactionManager, whereClause, orderBy, start, pageLength, out totalCount);
		...
		public virtual TList<SanPham> Find(string whereClause)
		{
			int totalCount = -1;
		...
		public override TList<SanPham> Find(string whereClause, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.SanPhamProvider.Find(transactionManager, whereClause, start, pageLength, out totalCount);
		...
		/// <returns>Returns a typed collection of <c>SanPham</c> objects.</returns>
		public virtual TList<SanPham> Find(IFilterParameterCollection parameters)
		{
		...
		/// <param name="orderBy">Specifies the sort criteria for the rows in the DataSource (Name ASC; BirthDay DESC, Name ASC);</param>
		/// <returns>Returns a typed collection of <c>SanPham</c> objects.</returns>
		public virtual TList<SanPham> Find(IFilterParameterCollection parameters, string orderBy)
		{
			int count = 0;
		...
		/// <returns>Returns a typed collection of <c>SanPham</c> objects.</returns>
		public virtual TList<SanPham> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				//Access repository
				list = dataProvider.SanPhamProvider.Find(transactionManager, parameters, orderBy, start, pageLength, out count);
			}
            catch (Exception exc)
            {
				//if open, rollback, it's possible this is part of a larger commit
		...
		public override bool Insert(SanPham entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.SanPhamProvider.Insert(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Inserts rows in <see cref="TList{SanPham}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>SanPham</c> objects in a <see cref="TList{SanPham}" /> object to Insert.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Insert)]
		public virtual TList<SanPham> Insert(TList<SanPham> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Insert");
			...
			{
				throw new Entities.EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<SanPham>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Insert
				dataProvider.SanPhamProvider.Insert(transactionManager, entityCollection); 
		...
		public override bool Update(SanPham entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.SanPhamProvider.Update(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Updates rows in <see cref="TList{SanPham}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>SanPham</c> objects in a <see cref="TList{SanPham}" /> object to Update.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<SanPham> Update(TList<SanPham> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Update");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<SanPham>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Update
				dataProvider.SanPhamProvider.Update(transactionManager, entityCollection); 
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override SanPham Save(SanPham entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				dataProvider.SanPhamProvider.Save(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Saves rows in <see cref="TList{SanPham}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>SanPham</c> objects in a <see cref="TList{SanPham}" /> object to Save.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<SanPham> Save(TList<SanPham> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Save");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<SanPham>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Save
				dataProvider.SanPhamProvider.Save(transactionManager, entityCollection); 
		...
		public override bool Delete(SanPham entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.SanPhamProvider.Delete(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Deletes rows in <see cref="TList{SanPham}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>SanPham</c> objects in a <see cref="TList{SanPham}" /> object to Delete.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual TList<SanPham> Delete(TList<SanPham> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<SanPham>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Delete
				dataProvider.SanPhamProvider.Delete(transactionManager, entityCollection); 
		...
		public bool Delete(SanPhamKey key)
		{
			return Delete(key.IdSanPham );
		}
		...
		/// <returns>Returns true if operation suceeded.</returns>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual bool Delete(System.Int64 idSanPham)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			try
            {
				...
				//Delete
				result = dataProvider.SanPhamProvider.Delete(transactionManager, idSanPham);
		...
		/// <summary>
		/// public virtualDeep Loads the requested <see cref="SanPham"/> by the entity keys.  The criteria of the child 
		...
		/// <returns>Returns an instance of the <see cref="SanPham"/> class and DeepLoaded.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual SanPham DeepLoadByIdSanPham(System.Int64 idSanPham, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadByIdSanPham");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			SanPham entity = GetByIdSanPham(idSanPham);
		...
		/// <remarks>
		/// <seealso cref="DeepLoad(SanPham)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(SanPham entity)
		{
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(SanPham entity, bool deep)
		{
		...
		/// </remarks>
		/// <param name="entity">The <see cref="SanPham"/> object to load.</param>
		...
		/// <param name="childTypes">SanPham Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(SanPham entity, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			...
			try
            {
				...
				dataProvider.SanPhamProvider.DeepLoad(transactionManager, entity, deep, deepLoadType, childTypes);
		...
		/// <summary>
		/// Deep Loads the <see cref="TList{SanPham}" /> object with all of the child 
		/// property collections only 1 Level Deep.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(SanPham)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		/// <param name="entityCollection">the <see cref="TList{SanPham}" /> Object to deep loads.</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<SanPham> entityCollection)
		{
			DeepLoad(entityCollection, false, DeepLoadType.ExcludeChildren, Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Loads the <see cref="TList{SanPham}" /> object.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(SanPham)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<SanPham> entityCollection, bool deep)
		{
			DeepLoad(entityCollection, deep, DeepLoadType.ExcludeChildren, Type.EmptyTypes);
		}	

		/// <summary>
		/// Deep Loads the entire <see cref="TList{SanPham}" /> object with criteria based of the child 
		/// property collections only N Levels Deep based on the DeepLoadType.
		/// </summary>
		/// <remarks>
		/// Use this method with caution as it is possible to DeepLoad with Recursion and traverse an entire collection's object graph.
		/// </remarks>
		/// <param name="entityCollection">The <see cref="TList{SanPham}" /> instance to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		...
		///	</param>
		/// <param name="childTypes"><see cref="SanPham"/> Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public override void DeepLoad(TList<SanPham> entityCollection, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{	
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoad");
			TransactionManager transactionManager = null; 
			...
			try
            {
				...
				//Call Deep Load from the Repository
				dataProvider.SanPhamProvider.DeepLoad(transactionManager, entityCollection, deep, deepLoadType, childTypes);
		...
		/// <summary>
		/// public virtualDeep Saves the <see cref="SanPham"/> object with all of the child
		/// property collections N Levels Deep.
		/// </summary>
		/// <param name="entity">SanPham Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(SanPham entity)
		{
		...
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(SanPham entity, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Save
				result = dataProvider.SanPhamProvider.DeepSave(transactionManager, entity, deepSaveType, childTypes);
		...
		/// <summary>
		/// Deep Save the entire <see cref="TList{SanPham}" /> object with all of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection">TList{SanPham} Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual bool DeepSave(TList<SanPham> entityCollection)
		{
			return DeepSave(entityCollection, DeepSaveType.ExcludeChildren, Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Save the entire object graph of the <see cref="TList{SanPham}" /> object with criteria based of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection"><see cref="TList{SanPham}" /> Object</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">SanPham Property Collection Type Array To Include or Exclude from Save</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(TList<SanPham> entityCollection, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{				
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepSave");
			...
			try
            {
				...
				transactionManager = ConnectionScope.ValidateOrCreateTransaction();
				NetTiersProvider dataProvider = ConnectionScope.Current.DataProvider;
				result = dataProvider.SanPhamProvider.DeepSave(transactionManager, entityCollection,  deepSaveType, childTypes);
