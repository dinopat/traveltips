...
{		
	...
	/// All custom implementations should be done in the <see cref="LoaiSp"/> class.
	/// </remarks>
	[DataObject]
	[CLSCompliant(true)]
	public partial class LoaiSpServiceBase : ServiceBase<LoaiSp, LoaiSpKey>
	{

		#region Constructors
		///<summary>
		/// Creates a new <see cref="LoaiSp"/> instance .
		///</summary>
		public LoaiSpServiceBase() : base()
		{
		}
		...
		public static LoaiSp CreateLoaiSp(System.Int64 idLoaiSp, System.Int64? idLoaiSpCha, System.String tenLoaiSp, System.String maLoaiSp, System.String moTa, System.Byte? flag)
		{
			...
			newEntityLoaiSp.MoTa  = moTa;
			newEntityLoaiSp.Flag  = flag;
			return newEntityLoaiSp;
		}
		#endregion Constructors


		#region Fields
		private static SecurityContext<LoaiSp> securityContext = new SecurityContext<LoaiSp>();
		...
		///</summary>
		public static SecurityContext<LoaiSp> SecurityContext
		{
			get
			{
		...
		public override LoaiSp Get(LoaiSpKey key)
		{
			return GetByIdLoaiSp(key.IdLoaiSp);
		}

		/// <summary>
		///  method that Gets rows in a <see cref="TList{LoaiSp}" /> from the datasource based on the primary key PK_tbl_LoaiSP index.
		/// </summary>
		/// <param name="idLoaiSp"></param>
		/// <returns>Returns an instance of the <see cref="LoaiSp"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual LoaiSp GetByIdLoaiSp(System.Int64 idLoaiSp)
		{
			int totalCount = -1;
		...
		/// <returns>Returns an instance of the <see cref="LoaiSp"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual LoaiSp GetByIdLoaiSp(System.Int64 idLoaiSp, int start, int pageLength, out int totalCount)
		{
            ...
            {	
				...
				//Access Repository
				entity = dataProvider.LoaiSpProvider.GetByIdLoaiSp(transactionManager, idLoaiSp, start, pageLength, out totalCount)   as LoaiSp;
		...
		#region GetAll
		/// <summary>
		/// Get a complete collection of <see cref="LoaiSp" /> entities.
		/// </summary>
		/// <returns></returns>
		public override TList<LoaiSp> GetAll() 
		{
			int totalCount = -1;
		...
		/// <summary>
		/// Get a set portion of a complete list of <see cref="LoaiSp" /> entities
		/// </summary>
		/// <param name="start">Row number at which to start reading.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="totalCount">out parameter, number of total rows in given query.</param>
		/// <returns>a <see cref="TList{LoaiSp}"/> </returns>
		public virtual TList<LoaiSp> GetAll(int start, int pageLength, out int totalCount) 
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetAll");
			
			// get this data
			TList<LoaiSp> list = null;
			totalCount = -1;
			TransactionManager transactionManager = null; 
            ...
            {	
				...
				//Access repository
				list = dataProvider.LoaiSpProvider.GetAll(transactionManager, start, pageLength, out totalCount);	
			}
            catch (Exception exc)
            {
				//if open, rollback, it's possible this is part of a  larger commit
		...
		#region GetPaged
		/// <summary>
		/// Gets a page of <see cref="TList{LoaiSp}" /> rows from the DataSource.
		/// </summary>
		/// <param name="totalCount">Out Parameter, Number of rows in the DataSource.</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>LoaiSp</c> objects.</returns>
		public virtual TList<LoaiSp> GetPaged(out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>LoaiSp</c> objects.</returns>
		public virtual TList<LoaiSp> GetPaged(int start, int pageLength, out int totalCount)
		{
			return GetPaged(null, null, start, pageLength, out totalCount);
		}

		/// <summary>
		/// Gets a page of entity rows with a <see cref="TList{LoaiSp}" /> from the DataSource with a where clause and order by clause.
		/// </summary>
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>LoaiSp</c> objects.</returns>
		public override TList<LoaiSp> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.LoaiSpProvider.GetPaged(transactionManager, whereClause, orderBy, start, pageLength, out totalCount);
		...
		public virtual TList<LoaiSp> Find(string whereClause)
		{
			int totalCount = -1;
		...
		public override TList<LoaiSp> Find(string whereClause, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.LoaiSpProvider.Find(transactionManager, whereClause, start, pageLength, out totalCount);
		...
		/// <returns>Returns a typed collection of <c>LoaiSp</c> objects.</returns>
		public virtual TList<LoaiSp> Find(IFilterParameterCollection parameters)
		{
		...
		/// <param name="orderBy">Specifies the sort criteria for the rows in the DataSource (Name ASC; BirthDay DESC, Name ASC);</param>
		/// <returns>Returns a typed collection of <c>LoaiSp</c> objects.</returns>
		public virtual TList<LoaiSp> Find(IFilterParameterCollection parameters, string orderBy)
		{
			int count = 0;
		...
		/// <returns>Returns a typed collection of <c>LoaiSp</c> objects.</returns>
		public virtual TList<LoaiSp> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				//Access repository
				list = dataProvider.LoaiSpProvider.Find(transactionManager, parameters, orderBy, start, pageLength, out count);
			}
            catch (Exception exc)
            {
				//if open, rollback, it's possible this is part of a larger commit
		...
		public override bool Insert(LoaiSp entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.LoaiSpProvider.Insert(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Inserts rows in <see cref="TList{LoaiSp}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>LoaiSp</c> objects in a <see cref="TList{LoaiSp}" /> object to Insert.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Insert)]
		public virtual TList<LoaiSp> Insert(TList<LoaiSp> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Insert");
			...
			{
				throw new Entities.EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<LoaiSp>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Insert
				dataProvider.LoaiSpProvider.Insert(transactionManager, entityCollection); 
		...
		public override bool Update(LoaiSp entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.LoaiSpProvider.Update(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Updates rows in <see cref="TList{LoaiSp}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>LoaiSp</c> objects in a <see cref="TList{LoaiSp}" /> object to Update.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<LoaiSp> Update(TList<LoaiSp> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Update");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<LoaiSp>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Update
				dataProvider.LoaiSpProvider.Update(transactionManager, entityCollection); 
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override LoaiSp Save(LoaiSp entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				dataProvider.LoaiSpProvider.Save(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Saves rows in <see cref="TList{LoaiSp}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>LoaiSp</c> objects in a <see cref="TList{LoaiSp}" /> object to Save.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<LoaiSp> Save(TList<LoaiSp> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Save");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<LoaiSp>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Save
				dataProvider.LoaiSpProvider.Save(transactionManager, entityCollection); 
		...
		public override bool Delete(LoaiSp entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.LoaiSpProvider.Delete(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Deletes rows in <see cref="TList{LoaiSp}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>LoaiSp</c> objects in a <see cref="TList{LoaiSp}" /> object to Delete.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual TList<LoaiSp> Delete(TList<LoaiSp> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<LoaiSp>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Delete
				dataProvider.LoaiSpProvider.Delete(transactionManager, entityCollection); 
		...
		public bool Delete(LoaiSpKey key)
		{
			return Delete(key.IdLoaiSp );
		}
		...
		/// <returns>Returns true if operation suceeded.</returns>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual bool Delete(System.Int64 idLoaiSp)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			try
            {
				...
				//Delete
				result = dataProvider.LoaiSpProvider.Delete(transactionManager, idLoaiSp);
		...
		/// <summary>
		/// public virtualDeep Loads the requested <see cref="LoaiSp"/> by the entity keys.  The criteria of the child 
		...
		/// <returns>Returns an instance of the <see cref="LoaiSp"/> class and DeepLoaded.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual LoaiSp DeepLoadByIdLoaiSp(System.Int64 idLoaiSp, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadByIdLoaiSp");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			LoaiSp entity = GetByIdLoaiSp(idLoaiSp);
		...
		/// <remarks>
		/// <seealso cref="DeepLoad(LoaiSp)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(LoaiSp entity)
		{
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(LoaiSp entity, bool deep)
		{
		...
		/// </remarks>
		/// <param name="entity">The <see cref="LoaiSp"/> object to load.</param>
		...
		/// <param name="childTypes">LoaiSp Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(LoaiSp entity, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			...
			try
            {
				...
				dataProvider.LoaiSpProvider.DeepLoad(transactionManager, entity, deep, deepLoadType, childTypes);
		...
		/// <summary>
		/// Deep Loads the <see cref="TList{LoaiSp}" /> object with all of the child 
		/// property collections only 1 Level Deep.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(LoaiSp)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		/// <param name="entityCollection">the <see cref="TList{LoaiSp}" /> Object to deep loads.</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<LoaiSp> entityCollection)
		{
			DeepLoad(entityCollection, false, DeepLoadType.ExcludeChildren, Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Loads the <see cref="TList{LoaiSp}" /> object.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(LoaiSp)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<LoaiSp> entityCollection, bool deep)
		{
			DeepLoad(entityCollection, deep, DeepLoadType.ExcludeChildren, Type.EmptyTypes);
		}	

		/// <summary>
		/// Deep Loads the entire <see cref="TList{LoaiSp}" /> object with criteria based of the child 
		/// property collections only N Levels Deep based on the DeepLoadType.
		/// </summary>
		/// <remarks>
		/// Use this method with caution as it is possible to DeepLoad with Recursion and traverse an entire collection's object graph.
		/// </remarks>
		/// <param name="entityCollection">The <see cref="TList{LoaiSp}" /> instance to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		...
		///	</param>
		/// <param name="childTypes"><see cref="LoaiSp"/> Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public override void DeepLoad(TList<LoaiSp> entityCollection, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{	
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoad");
			TransactionManager transactionManager = null; 
			...
			try
            {
				...
				//Call Deep Load from the Repository
				dataProvider.LoaiSpProvider.DeepLoad(transactionManager, entityCollection, deep, deepLoadType, childTypes);
		...
		/// <summary>
		/// public virtualDeep Saves the <see cref="LoaiSp"/> object with all of the child
		/// property collections N Levels Deep.
		/// </summary>
		/// <param name="entity">LoaiSp Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(LoaiSp entity)
		{
		...
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(LoaiSp entity, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Save
				result = dataProvider.LoaiSpProvider.DeepSave(transactionManager, entity, deepSaveType, childTypes);
		...
		/// <summary>
		/// Deep Save the entire <see cref="TList{LoaiSp}" /> object with all of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection">TList{LoaiSp} Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual bool DeepSave(TList<LoaiSp> entityCollection)
		{
			return DeepSave(entityCollection, DeepSaveType.ExcludeChildren, Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Save the entire object graph of the <see cref="TList{LoaiSp}" /> object with criteria based of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection"><see cref="TList{LoaiSp}" /> Object</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">LoaiSp Property Collection Type Array To Include or Exclude from Save</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(TList<LoaiSp> entityCollection, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{				
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepSave");
			...
			try
            {
				...
				transactionManager = ConnectionScope.ValidateOrCreateTransaction();
				NetTiersProvider dataProvider = ConnectionScope.Current.DataProvider;
				result = dataProvider.LoaiSpProvider.DeepSave(transactionManager, entityCollection,  deepSaveType, childTypes);
