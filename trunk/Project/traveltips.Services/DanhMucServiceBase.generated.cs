...
{		
	...
	/// All custom implementations should be done in the <see cref="DanhMuc"/> class.
	/// </remarks>
	[DataObject]
	[CLSCompliant(true)]
	public partial class DanhMucServiceBase : ServiceBase<DanhMuc, DanhMucKey>
	{

		#region Constructors
		///<summary>
		/// Creates a new <see cref="DanhMuc"/> instance .
		///</summary>
		public DanhMucServiceBase() : base()
		{
		}
		...
		public static DanhMuc CreateDanhMuc(System.Int64? idDmCha, System.String tenDanhMuc, System.String maDanhMuc, System.String moTa, System.Byte? flag)
		{
			...
			newEntityDanhMuc.MoTa  = moTa;
			newEntityDanhMuc.Flag  = flag;
			return newEntityDanhMuc;
		}
		#endregion Constructors


		#region Fields
		private static SecurityContext<DanhMuc> securityContext = new SecurityContext<DanhMuc>();
		...
		///</summary>
		public static SecurityContext<DanhMuc> SecurityContext
		{
			get
			{
		...
		public override DanhMuc Get(DanhMucKey key)
		{
			return GetByIdDanhMuc(key.IdDanhMuc);
		}

		/// <summary>
		///  method that Gets rows in a <see cref="TList{DanhMuc}" /> from the datasource based on the primary key PK_tbl_DanhMuc index.
		/// </summary>
		/// <param name="idDanhMuc"></param>
		/// <returns>Returns an instance of the <see cref="DanhMuc"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual DanhMuc GetByIdDanhMuc(System.Int64 idDanhMuc)
		{
			int totalCount = -1;
		...
		/// <returns>Returns an instance of the <see cref="DanhMuc"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual DanhMuc GetByIdDanhMuc(System.Int64 idDanhMuc, int start, int pageLength, out int totalCount)
		{
            ...
            {	
				...
				//Access Repository
				entity = dataProvider.DanhMucProvider.GetByIdDanhMuc(transactionManager, idDanhMuc, start, pageLength, out totalCount)   as DanhMuc;
		...
		#region GetAll
		/// <summary>
		/// Get a complete collection of <see cref="DanhMuc" /> entities.
		/// </summary>
		/// <returns></returns>
		public override TList<DanhMuc> GetAll() 
		{
			int totalCount = -1;
		...
		/// <summary>
		/// Get a set portion of a complete list of <see cref="DanhMuc" /> entities
		/// </summary>
		/// <param name="start">Row number at which to start reading.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="totalCount">out parameter, number of total rows in given query.</param>
		/// <returns>a <see cref="TList{DanhMuc}"/> </returns>
		public virtual TList<DanhMuc> GetAll(int start, int pageLength, out int totalCount) 
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetAll");
			
			// get this data
			TList<DanhMuc> list = null;
			totalCount = -1;
			TransactionManager transactionManager = null; 
            ...
            {	
				...
				//Access repository
				list = dataProvider.DanhMucProvider.GetAll(transactionManager, start, pageLength, out totalCount);	
			}
            catch (Exception exc)
            {
				//if open, rollback, it's possible this is part of a  larger commit
		...
		#region GetPaged
		/// <summary>
		/// Gets a page of <see cref="TList{DanhMuc}" /> rows from the DataSource.
		/// </summary>
		/// <param name="totalCount">Out Parameter, Number of rows in the DataSource.</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>DanhMuc</c> objects.</returns>
		public virtual TList<DanhMuc> GetPaged(out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>DanhMuc</c> objects.</returns>
		public virtual TList<DanhMuc> GetPaged(int start, int pageLength, out int totalCount)
		{
			return GetPaged(null, null, start, pageLength, out totalCount);
		}

		/// <summary>
		/// Gets a page of entity rows with a <see cref="TList{DanhMuc}" /> from the DataSource with a where clause and order by clause.
		/// </summary>
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>DanhMuc</c> objects.</returns>
		public override TList<DanhMuc> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.DanhMucProvider.GetPaged(transactionManager, whereClause, orderBy, start, pageLength, out totalCount);
		...
		public virtual TList<DanhMuc> Find(string whereClause)
		{
			int totalCount = -1;
		...
		public override TList<DanhMuc> Find(string whereClause, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.DanhMucProvider.Find(transactionManager, whereClause, start, pageLength, out totalCount);
		...
		/// <returns>Returns a typed collection of <c>DanhMuc</c> objects.</returns>
		public virtual TList<DanhMuc> Find(IFilterParameterCollection parameters)
		{
		...
		/// <param name="orderBy">Specifies the sort criteria for the rows in the DataSource (Name ASC; BirthDay DESC, Name ASC);</param>
		/// <returns>Returns a typed collection of <c>DanhMuc</c> objects.</returns>
		public virtual TList<DanhMuc> Find(IFilterParameterCollection parameters, string orderBy)
		{
			int count = 0;
		...
		/// <returns>Returns a typed collection of <c>DanhMuc</c> objects.</returns>
		public virtual TList<DanhMuc> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				//Access repository
				list = dataProvider.DanhMucProvider.Find(transactionManager, parameters, orderBy, start, pageLength, out count);
			}
            catch (Exception exc)
            {
				//if open, rollback, it's possible this is part of a larger commit
		...
		public override bool Insert(DanhMuc entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.DanhMucProvider.Insert(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Inserts rows in <see cref="TList{DanhMuc}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>DanhMuc</c> objects in a <see cref="TList{DanhMuc}" /> object to Insert.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Insert)]
		public virtual TList<DanhMuc> Insert(TList<DanhMuc> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Insert");
			...
			{
				throw new Entities.EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<DanhMuc>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Insert
				dataProvider.DanhMucProvider.Insert(transactionManager, entityCollection); 
		...
		public override bool Update(DanhMuc entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.DanhMucProvider.Update(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Updates rows in <see cref="TList{DanhMuc}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>DanhMuc</c> objects in a <see cref="TList{DanhMuc}" /> object to Update.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<DanhMuc> Update(TList<DanhMuc> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Update");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<DanhMuc>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Update
				dataProvider.DanhMucProvider.Update(transactionManager, entityCollection); 
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override DanhMuc Save(DanhMuc entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				dataProvider.DanhMucProvider.Save(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Saves rows in <see cref="TList{DanhMuc}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>DanhMuc</c> objects in a <see cref="TList{DanhMuc}" /> object to Save.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<DanhMuc> Save(TList<DanhMuc> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Save");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<DanhMuc>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Save
				dataProvider.DanhMucProvider.Save(transactionManager, entityCollection); 
		...
		public override bool Delete(DanhMuc entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.DanhMucProvider.Delete(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Deletes rows in <see cref="TList{DanhMuc}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>DanhMuc</c> objects in a <see cref="TList{DanhMuc}" /> object to Delete.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual TList<DanhMuc> Delete(TList<DanhMuc> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<DanhMuc>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Delete
				dataProvider.DanhMucProvider.Delete(transactionManager, entityCollection); 
		...
		public bool Delete(DanhMucKey key)
		{
			return Delete(key.IdDanhMuc );
		}
		...
		/// <returns>Returns true if operation suceeded.</returns>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual bool Delete(System.Int64 idDanhMuc)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			try
            {
				...
				//Delete
				result = dataProvider.DanhMucProvider.Delete(transactionManager, idDanhMuc);
		...
		/// <summary>
		/// public virtualDeep Loads the requested <see cref="DanhMuc"/> by the entity keys.  The criteria of the child 
		...
		/// <returns>Returns an instance of the <see cref="DanhMuc"/> class and DeepLoaded.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual DanhMuc DeepLoadByIdDanhMuc(System.Int64 idDanhMuc, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadByIdDanhMuc");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			DanhMuc entity = GetByIdDanhMuc(idDanhMuc);
		...
		/// <remarks>
		/// <seealso cref="DeepLoad(DanhMuc)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(DanhMuc entity)
		{
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(DanhMuc entity, bool deep)
		{
		...
		/// </remarks>
		/// <param name="entity">The <see cref="DanhMuc"/> object to load.</param>
		...
		/// <param name="childTypes">DanhMuc Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(DanhMuc entity, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			...
			try
            {
				...
				dataProvider.DanhMucProvider.DeepLoad(transactionManager, entity, deep, deepLoadType, childTypes);
		...
		/// <summary>
		/// Deep Loads the <see cref="TList{DanhMuc}" /> object with all of the child 
		/// property collections only 1 Level Deep.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(DanhMuc)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		/// <param name="entityCollection">the <see cref="TList{DanhMuc}" /> Object to deep loads.</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<DanhMuc> entityCollection)
		{
			DeepLoad(entityCollection, false, DeepLoadType.ExcludeChildren, Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Loads the <see cref="TList{DanhMuc}" /> object.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(DanhMuc)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<DanhMuc> entityCollection, bool deep)
		{
			DeepLoad(entityCollection, deep, DeepLoadType.ExcludeChildren, Type.EmptyTypes);
		}	

		/// <summary>
		/// Deep Loads the entire <see cref="TList{DanhMuc}" /> object with criteria based of the child 
		/// property collections only N Levels Deep based on the DeepLoadType.
		/// </summary>
		/// <remarks>
		/// Use this method with caution as it is possible to DeepLoad with Recursion and traverse an entire collection's object graph.
		/// </remarks>
		/// <param name="entityCollection">The <see cref="TList{DanhMuc}" /> instance to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		...
		///	</param>
		/// <param name="childTypes"><see cref="DanhMuc"/> Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public override void DeepLoad(TList<DanhMuc> entityCollection, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{	
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoad");
			TransactionManager transactionManager = null; 
			...
			try
            {
				...
				//Call Deep Load from the Repository
				dataProvider.DanhMucProvider.DeepLoad(transactionManager, entityCollection, deep, deepLoadType, childTypes);
		...
		/// <summary>
		/// public virtualDeep Saves the <see cref="DanhMuc"/> object with all of the child
		/// property collections N Levels Deep.
		/// </summary>
		/// <param name="entity">DanhMuc Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(DanhMuc entity)
		{
		...
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(DanhMuc entity, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Save
				result = dataProvider.DanhMucProvider.DeepSave(transactionManager, entity, deepSaveType, childTypes);
		...
		/// <summary>
		/// Deep Save the entire <see cref="TList{DanhMuc}" /> object with all of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection">TList{DanhMuc} Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual bool DeepSave(TList<DanhMuc> entityCollection)
		{
			return DeepSave(entityCollection, DeepSaveType.ExcludeChildren, Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Save the entire object graph of the <see cref="TList{DanhMuc}" /> object with criteria based of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection"><see cref="TList{DanhMuc}" /> Object</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">DanhMuc Property Collection Type Array To Include or Exclude from Save</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(TList<DanhMuc> entityCollection, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{				
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepSave");
			...
			try
            {
				...
				transactionManager = ConnectionScope.ValidateOrCreateTransaction();
				NetTiersProvider dataProvider = ConnectionScope.Current.DataProvider;
				result = dataProvider.DanhMucProvider.DeepSave(transactionManager, entityCollection,  deepSaveType, childTypes);
