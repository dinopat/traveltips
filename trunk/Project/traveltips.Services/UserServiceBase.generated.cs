...
{		
	...
	public partial class UserServiceBase : ServiceBase<User, UserKey>
	{
		...
		public static User CreateUser(System.Int64 idUser, System.Byte[] tenDangNhap, System.String password, System.String hoTen, System.String email, System.String diaChi, System.Byte[] dienThoai, System.String website, System.String avatar, System.Byte? flag)
		{
			...
			newEntityUser.DiaChi  = diaChi;
			newEntityUser.DienThoai  = dienThoai;
			newEntityUser.Website  = website;
			newEntityUser.Avatar  = avatar;
			newEntityUser.Flag  = flag;
		...
		{
			return GetByIdUser(key.IdUser);
		}

		/// <summary>
		///  method that Gets rows in a <see cref="TList{User}" /> from the datasource based on the primary key PK_tbl_User index.
		/// </summary>
		/// <param name="idUser"></param>
		/// <returns>Returns an instance of the <see cref="User"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual User GetByIdUser(System.Int64 idUser)
		{
			int totalCount = -1;
		...
		/// <returns>Returns an instance of the <see cref="User"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual User GetByIdUser(System.Int64 idUser, int start, int pageLength, out int totalCount)
		{
            ...
            {	
				...
				//Access Repository
				entity = dataProvider.UserProvider.GetByIdUser(transactionManager, idUser, start, pageLength, out totalCount)   as User;
		...
		/// <returns>Returns true if operation suceeded.</returns>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual bool Delete(System.Int64 idUser)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			try
            {
				...
				//Delete
				result = dataProvider.UserProvider.Delete(transactionManager, idUser);
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual User DeepLoadByIdUser(System.Int64 idUser, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadByIdUser");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			User entity = GetByIdUser(idUser);
